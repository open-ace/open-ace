    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            assistant_messages = page.locator(
                '.message-assistant, [data-role="assistant"], .card:has(.badge:has-text("assistant"))'
            )
            ...
            if count > 0:
                ...
                if model_found:
                    ...
                    model_badge = page.locator(
                        '.badge:has-text("claude"), .badge:has-text("gpt"), '
                        '.badge:has-text("qwen"), .model-label, [data-model]'
                    )
