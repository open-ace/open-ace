...
def upgrade() -> None:
    ...
    add_column_if_not_exists(
        ...
        "billing_cycle_type",
        sa.Column(
            "billing_cycle_type", sa.String(20), default="monthly", comment="Billing cycle type"
        ),
    )
    ...
    add_column_if_not_exists(
        ...
        sa.Column(
            ...
            sa.Date(),
            nullable=True,
            comment="Current billing cycle start date",
        ),
    )
    ...
    add_column_if_not_exists(
        ...
        "billing_cycle_end",
        sa.Column(
            "billing_cycle_end", sa.Date(), nullable=True, comment="Current billing cycle end date"
        ),
    )
    ...
    add_column_if_not_exists(
        ...
        sa.Column(
            ...
            sa.String(20),
            default="soft",
            comment="Over limit strategy: soft, hard, billable",
        ),
    )
    ...
    add_column_if_not_exists(
        "tenants",
        "over_limit_price_per_token",
        sa.Column(
            "over_limit_price_per_token",
            sa.Numeric(10, 6),
            nullable=True,
            comment="Price per token when over limit",
        ),
    )
    ...
    add_column_if_not_exists(
        ...
        sa.Column(
            ...
            sa.Integer(),
            default=80,
            comment="Usage alert threshold percentage",
        ),
    )
    ...
    add_column_if_not_exists(
        ...
        sa.Column(
            ...
            sa.Integer(),
            default=95,
            comment="Usage critical threshold percentage",
        ),
    )
    ...
    add_column_if_not_exists(
        ...
        "alert_silence_hours",
        sa.Column(
            "alert_silence_hours", sa.Integer(), default=24, comment="Alert silence period in hours"
        ),
    )
