...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP')),
        sa.UniqueConstraint('date', 'tool_name', 'message_id', 'host_name', name='uq_daily_messages_date_tool_msg_host'),
    )
    ...
    op.create_index('idx_messages_date_tool_host', 'daily_messages', ['date', 'tool_name', 'host_name'])
    op.create_index('idx_messages_date_timestamp', 'daily_messages', ['date', sa.text('timestamp DESC')])
    op.create_index('idx_messages_date_role_timestamp', 'daily_messages', ['date', 'role', sa.text('timestamp DESC')])
