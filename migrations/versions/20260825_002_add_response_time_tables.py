...
def upgrade() -> None:
    ...
    # SQLite and PostgreSQL compatible table creation
    # Using TEXT for timestamps to match existing schema style

    # Create request_performance table
    op.execute("""
    ...
    # Create indexes for request_performance
    op.execute("""
    ...
    # Create response_time_stats table
    op.execute("""
    ...
    # Create indexes for response_time_stats
    op.execute("""
