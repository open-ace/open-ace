"""Fix agent identity boolean columns retroactively

Revision ID: 20260615_063_fix_boolean_retroactive
Revises: 20260614_062_milestone_tldr
...
- For PostgreSQL: converts INTEGER to BOOLEAN only when needed
- For SQLite: no changes (type affinity)
