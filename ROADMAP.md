...
- Add a safe public demo path that does not expose shared admin credentials. A self-hosted [10-minute demo walkthrough](docs/en/DEMO-10-MINUTES.md) is now documented; a hosted shared-credential demo remains the next step.
- Improve production deployment docs for TLS, secrets, backups, SSO, and Kubernetes. The [security model](docs/en/SECURITY.md) and a production hardening checklist are now documented.
...
- New users can run Open ACE locally in under 10 minutes. → A step-by-step [10-minute demo](docs/en/DEMO-10-MINUTES.md) now documents this path end to end.
