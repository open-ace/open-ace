...
def upload_incremental(server_url: str, auth_key: str, hostname: str, 
                      last_sync_time: str = None) -> tuple:
    """
...
def sync_data(server_url: str, auth_key: str, hostname: str, days: int = 1, 
...
def run_daemon(server_url: str = None, auth_key: str = None, hostname: str = None, 
               interval: int = 300, days: int = 1, config_path: str = None):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Fetch and upload data to central server (incremental sync)')
    ...
    parser.add_argument('--days', type=int, default=1, help='Days to fetch on initial sync (default: 1)')
