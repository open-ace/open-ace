...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    notificationIntegrationDesc:
      'Manage system notification channels and collaboration connections. Recipients, targets, and alert levels remain in Quota & Alerts notification settings.',
    integrationChannels: 'Notification channels',
    integrationCollaboration: 'Collaboration platforms',
    integrationEmail: 'Email',
    integrationEmailDesc: 'SMTP server connection',
    integrationWebhook: 'Generic Webhook',
    integrationWebhookDesc: 'Global signing and security policy',
    integrationDingTalkBot: 'DingTalk bot',
    integrationDingTalkBotDesc: 'Platform delivery capability',
    integrationFeishuBot: 'Feishu bot',
    integrationFeishuBotDesc: 'Targets are configured per user or tenant',
    integrationFeishuApp: 'Feishu app · Organization sync',
    integrationDingTalkApp: 'DingTalk app · Organization sync',
    integrationWebhookTitle: 'Generic Webhook · Global security',
    integrationDingTalkBotTitle: 'DingTalk bot · Delivery capability',
    integrationFeishuBotTitle: 'Feishu bot · Delivery capability',
    integrationSigningSecret: 'Signing secret',
    integrationFallbackSecret: 'Compatibility fallback signing secret',
    integrationSecretKeepHint: 'Leave blank to keep the saved secret',
    integrationDeliveryEnabled: 'Enable delivery',
    integrationAllowPrivate: 'Allow private addresses (SSRF risk)',
    integrationBotBoundary:
      'This page does not store a target URL. Prefer user or tenant secrets; the system secret is only a legacy fallback.',
    integrationFeishuNoConfig:
      'No system configuration is required. Configure each bot target and secret in notification settings.',
    integrationGoToNotifications: 'Go to notification settings',
    integrationAutoSync: 'Enable automatic sync',
    integrationTargetTenant: 'Target tenant',
    integrationSelectTenant: 'Select a tenant',
    integrationInterval: 'Sync interval (minutes)',
    integrationRootDepartment: 'Root department ID',
    integrationMaxRuntime: 'Maximum runtime (seconds)',
    integrationAutoRecovery: 'Automatically recover a stuck sync',
    integrationSyncNow: 'Sync now',
    integrationSyncResult: 'Latest sync result',
    integrationSyncConfirm: 'Run organization sync for the selected tenant now?',
    integrationSyncSuccess: 'Organization sync completed',
    integrationTenantRequired: 'Select a valid target tenant first',
    integrationSaved: 'Configuration saved',
    integrationTestSuccess: 'Connection test successful',
    integrationTestFailed: 'Connection test failed',
    integrationStatusConfigured: 'Configured',
    integrationStatusEnabled: 'Enabled',
    integrationStatusAvailable: 'Available',
    ...
    lastRefreshTooltipHint: 'Click the refresh button to get the latest data',
    nextRefresh: 'Next Refresh',
    noRefreshYet: 'No refresh yet',
    ...
    editPolicyRule: 'Edit Policy Rule',
    editPolicyRuleVersioned: 'Edit Policy Rule (will create new version)',
    ruleKey: 'Rule Key',
    ruleName: 'Rule Name',
    ...
    noPolicyRules: 'No policy rules found',
    noPolicyRulesHelp: 'Create your first policy rule to get started',
    confirmDisableRule: 'Are you sure you want to disable this rule?',
    confirmEnableRule: 'Are you sure you want to enable this rule?',
    ruleToggledSuccess: 'Rule updated successfully',
    ruleToggledFailed: 'Failed to update rule',
    ruleCreatedSuccess: 'Policy rule created successfully',
    ruleUpdatedSuccess: 'Policy rule updated successfully (new version created)',
    ruleKeyRequired: 'Rule key is required',
    ruleNameRequired: 'Rule name is required',
    policyTypeRequired: 'Policy type is required',
    effectRequired: 'Effect is required',
    patternOrValueRequired: 'Pattern or value list is required for this policy type',
    toolNameRequired: 'Tool name is required for tool_action type',
    actionRequired: 'Action is required for tool_action type',
    invalidRegexPattern: 'Invalid regex pattern',
    contactAdmin: 'Please contact your administrator',
    enterSessionId: 'Enter a session ID to view policy decisions',
    decisionId: 'Decision ID',
    decision: 'Decision',
    regexPatternHelp: 'Enter a valid regular expression',

    // Policy Types
    policyTypeModel: 'Model',
    policyTypeProvider: 'Provider',
    policyTypeToolAction: 'Tool Action',
    policyTypeFilePath: 'File Path',
    ...
    conversationHistoryListCount: '{count} conversations',
    ...
    expand: 'Expand',
    collapse: 'Collapse',
    autoExpandDetails: 'Expand Details',
    autoCollapseDetails: 'Collapse Details',
    ...
    noEfficiencyData: 'No efficiency data available',
    outputRatio: 'Output Ratio',
    outputRatioHelp: 'Percentage of output tokens relative to total tokens',
    tokensPerRequest: 'Tokens per Request',
    outputPerRequest: 'Output per Request',
    inputOutputRatio: 'Input/Output Ratio',
    inputOutputRatioHelp: 'Ratio of input tokens to output tokens',
    ...
    categoryPatterns: 'Match Patterns',
    categoryPatternsHint: 'Enter keywords to match project paths (case-insensitive)',
    categorySortOrder: 'Sort Order',
    categoryProjectCount: 'Projects',
    keywordConflictWarning: 'Keyword Conflict Warning',
    impactPreview: 'Impact Preview',
    willAddProjects: 'Will add projects',
    willRemoveProjects: 'Will remove projects',
    ...
    projectSharedHint:
      'When enabled, other users can access this project. Large projects may take time to process.',
    projectUpdated: 'Project updated successfully',
    projectEditNoPermission: 'You do not have permission to edit this project',
    ...
    noVisibleUsers: 'No visible users yet',
    ...
    userHasActiveSessions: 'This user has {{count}} active session(s)',
    ...
    systemNameHelper: 'This name will be displayed on the login page title.',
    welcomeMessageConfiguration: 'Welcome Message Configuration',
    welcomeMessageHelper:
      'Configure welcome messages in different languages. If a language is not configured, the system will fall back to English.',
    welcomeMessage: 'Welcome Message',
    welcomeMessagePlaceholder: 'Please sign in to continue',
    copyrightConfiguration: 'Copyright Configuration',
    copyrightText: 'Copyright Text',
    copyrightHelper: 'This text will be displayed in the login page footer.',
    brandingInfoTitle: 'Branding Configuration',
    brandingInfoDescription:
      'Changes to branding settings will be reflected on the login page. The logo URL must be a public HTTPS URL.',
    failedToFetchBrandingSettings: 'Failed to fetch branding settings',
    ...
    noTenantsDescription: 'Please contact system administrator to assign tenant permissions.',
    noTenantDescription: 'Please contact system administrator to configure your tenant.',
    ...
    fileNotReadable: 'You do not have permission to access this file',
    uploadTooLarge: 'File too large',
    uploadTooLargeDesc: 'Maximum size is {size}MB',
    noFiles: 'No files or subdirectories',
    ...
    searchTruncated: 'Showing first {count} matches. Refine your query to narrow down.',
    backToCurrentDir: 'Back to current directory',
    clearSearch: 'Clear search',
    notWritable: 'Directory is not writable',
    ...
    testAlertCreated: 'Test Alert Created',
    testAlertCreatedDesc:
      'A test alert has been created. Notifications are being sent to configured channels.',
    testAlertFailed: 'Failed to Send Test Alert',
    testAlertCooldown: 'Please wait {seconds}s before sending another test alert',
    ...
    noAlertsDescription: 'You have no alerts at this time. New alerts will appear here.',
    myAlerts: 'My Alerts',
    ...
    smtpPasswordRequiredForTest: 'Password is required to test connection with username.',
    ...
    syncTargetTenant: 'Sync Target Tenant',
    autoSync: 'Auto Sync',
    syncInterval: 'Sync Interval',
    feishuNotConfigured: 'Not Configured',
    feishuConnected: 'Connected',
    feishuInvalid: 'Invalid',
    feishuConfiguredUnverified: 'Pending Verification',
    feishuConnectionFailed: 'Connection Failed',
    feishuConfigurationError: 'Configuration Error',
    feishuConfigSaved: 'Feishu Configuration Saved',
    feishuConfigSavedDesc: 'Feishu configuration has been saved successfully',
    feishuTestSuccess: 'Connection Test Successful',
    feishuTestFailed: 'Connection Test Failed',
    feishuConfigExists: 'Feishu configuration already exists',
    confirmSaveFeishuConfig: 'Confirm Feishu Configuration Changes',
    confirmDeleteFeishuConfig: 'Are you sure you want to delete Feishu configuration?',
    feishuConfigDeleted: 'Feishu Configuration Deleted',
    feishuConfigDeletedDesc: 'Feishu configuration has been deleted',
    enterFeishuAppId: 'Enter Feishu App ID',
    enterFeishuAppSecret: 'Enter Feishu App Secret',
    enterFeishuTenantId: 'Enter Feishu Tenant ID (optional)',
    currentSecret: 'Current Secret',
    feishuTenantIdHint: 'Leave empty to sync to current tenant',
    feishuAutoSyncHint: 'Automatically sync users from Feishu',
    feishuSyncIntervalHint: 'Range: 1-1440 minutes',
    feishuAppIdRequired: 'App ID is required',
    feishuAppSecretRequired: 'App Secret is required for new configuration or when App ID changes',
    feishuSyncIntervalRange: 'Sync interval must be between 1 and 1440 minutes',
    lastSyncAt: 'Last Sync',
    show: 'Show',
    hide: 'Hide',
    feishuSetupGuide: 'Feishu Setup Guide',
    feishuSetupGuide1: 'Create a Feishu app in Feishu Open Platform',
    feishuSetupGuide2: 'Copy the App ID and App Secret from the app credentials',
    feishuSetupGuide3: 'Configure the required permissions for user data access',
    feishuSetupGuide4: 'Click "Test Connection" to verify the configuration',
    ...
    roiAssumptions: 'ROI Assumptions',
    roiAppliedAssumptions: 'Applied baseline',
    roiAssumptionsHelp:
    ...
    roiAssumptionValidation:
      'Enter positive values for labor cost, productivity multiplier, and time saved, plus a 1-8 character currency label.',
    ...
    avgTimeSavedPerRequest: 'Avg time saved / request',
    productivityMultiplier: 'Productivity multiplier',
    currency: 'Currency',
    costBreakdown: 'Cost Breakdown',
    roiByUser: 'ROI by User',
    userIdentifier: 'User',
    ...
    // Efficiency Algorithm V2
    efficiencyAlgorithmVersion: 'Algorithm Version',
    efficiencyAlgorithmV1: 'V1.0 (Legacy)',
    efficiencyAlgorithmV2: 'V2.0 (Task Type Aware)',
    efficiencyAlgorithmAuto: 'Auto (A/B Test)',
    efficiencyTaskType: 'Task Type',
    efficiencyTaskTypeAuto: 'Auto Detect',
    efficiencyTaskTypeGeneral: 'General',
    efficiencyTaskTypeCodeGeneration: 'Code Generation',
    efficiencyTaskTypeDocumentAnalysis: 'Document Analysis',
    efficiencyTaskTypeConversation: 'Conversation',
    efficiencyAppliedTaskType: 'Applied Task Type',
    efficiencyInferenceConfidence: 'Inference Confidence',
    efficiencyAdvancedFilters: 'Advanced Filters',
    ...
    // Issue #3197: Tenant usage statistics
    tenantUserCount: 'User Count',
    tenantTotalUsers: 'Total Users',
    tenantTotalTokens: 'Total Tokens',
    tenantTotalRequests: 'Total Requests',
    tenantTokenUsage: 'Token Usage',
    tenantRequestUsage: 'Request Usage',
    tenantCumulativeUsageTooltip: 'Cumulative usage since tenant creation',
    tenantUsageStats: 'Usage Stats',
    tenantViewDetails: 'View Details',
    tenantDetailTitle: 'Tenant Details',
    tenantDailyUsage: 'Daily Usage',
    tenantMonthlyUsage: 'Monthly Usage',
    tenantUsageTrend: 'Usage Trend',
    tenantActiveUsers: 'Active Users',
    tenantNoData: 'No data',
    tenantLast30Days: 'Last 30 Days',
    tenantBillingCyclePending: 'Pending',
    max: 'Max',
    ...
    noProvidersHint: 'Add an SSO provider to enable single sign-on authentication for your users.',
    ...
    enterClientSecretConfirm: 'Re-enter client secret',
    clientSecretMismatch: 'Client secrets do not match',
    ...
    confirmEnableProvider:
      'Are you sure you want to enable this provider? This will restore the SSO login entry.',
    providerEnabled: 'Provider enabled successfully',
    providerDisabled: 'Provider disabled successfully',
    enableProviderFailed: 'Failed to enable provider',
    disableProviderFailed: 'Failed to disable provider',
    providerDetail: 'Provider Detail',
    view: 'View',
    providerNotFound: 'Provider not found',
    failedToLoadProviderDetail: 'Failed to load provider details',
    editProvider: 'Edit Provider',
    clientSecretEditHint: 'Leave blank to keep current secret, enter new value to update',
    ...
    rotateKeyConfirmation: 'Key Rotation Confirmation',
    rotateKeyWarning:
      'This operation will generate a new encryption key and mark the current key as deprecated.',
    rotateKeyBenefit1: 'Generate a new encryption key (Fernet standard)',
    rotateKeyBenefit2: 'Mark the current key as deprecated',
    rotateKeyBenefit3: 'New key will be used for all subsequent encryption operations',
    rotateKeyBenefit4: 'Existing user sessions and Agent connections will not be affected',
    currentConfigVersion: 'Current config version',
    enterRotateToConfirm: 'Enter "ROTATE" to confirm',
    rotating: 'Rotating...',
    ...
    rotateKeyTip1: 'Key rotation will generate a new key and mark the current key as deprecated',
    rotateKeyTip2: 'Deprecated keys can still decrypt historical data',
    rotateKeyTip3: 'It is recommended to periodically re-encrypt stored data to ensure security',
    rotateKeyTip4: 'Key format must comply with Fernet standard (32-byte base64)',
    multiReplicaSyncStatus: 'Multi-replica Sync Status',
    localConfigVersion: 'Local config version',
    replicaName: 'Replica name',
    overallStatus: 'Overall status',
    allReplicasSynced: 'All replicas synchronized',
    someReplicasLagging: 'Some replicas lagging',
    unknownStatus: 'Unknown status',
    noReplicasConfigured: 'No other replicas configured',
    lagging: 'Lagging',
    unavailable: 'Unavailable',
    preCheckCiphertext: 'Pre-check Ciphertext',
    reEncryptData: 'Re-encrypt Data',
    reEncryptPreCheck: 'Re-encrypt Pre-check',
    checkingCiphertext: 'Checking ciphertext...',
    ciphertextStats: 'Ciphertext Statistics',
    totalCiphertexts: 'Total ciphertexts',
    withKeyIdPrefix: 'With key_id prefix',
    legacyFormat: 'Legacy format',
    decryptionTest: 'Decryption Test',
    allCiphertextsDecryptable: 'All ciphertexts can be decrypted',
    someCiphertextsUndecryptable: 'Some ciphertexts cannot be decrypted',
    clickToRunPreCheck: 'Click "Run Pre-check" to check ciphertext format',
    runPreCheck: 'Run Pre-check',
    errorLoadingKeys: 'Error loading encryption keys',
    inconsistencyDetected: 'Inconsistency detected between environment variables and database',
    runMigration: 'Run Migration',
    auditLogComingSoon: 'Audit log feature coming soon',
    ...
    terminalStopRequestSent: 'Terminal stop request sent successfully',
    terminalStopFailed: 'Failed to stop terminal',
    ...
    autoBackToWorkflowList: 'Back to Workflows',
    ...
    terminalModelHint: 'Select a model to use its API key configuration',
    terminalProtocolHint: 'Model will be configured with the corresponding API key.',
    loadingModels: 'Loading models...',
    noModelsAvailable: 'No models available. Please configure API keys in Settings.',
    autoNoModelsForTool: 'No models configured for this tool. Add an API key in Settings first.',
    autoModelsLoadFailed: 'Failed to load models.',
    ...
    autoWorktreeOnlyMultiUser: 'Multi-user mode requires an isolated worktree.',
    ...
    autoRequireFullReviewRounds: 'Must run full review rounds',
    autoRequireFullReviewRoundsHint: 'Do not stop planning or PR review early after approval.',
    ...
    autoPolicyPanelTitle: 'Agent Runtime & Isolation',
    ...
    autoPolicyNoLimits: 'No resource limits set (policy file loaded, but all limits are unset)',
    ...
    autoPolicyEnforcedYes: 'enforced',
    autoPolicyEnforcedNo: 'not enforced',
    autoPolicyMemory: 'Memory',
    autoPolicyPids: 'Processes',
    autoPolicyCpu: 'CPU',
    autoPolicyWallClock: 'Wall-clock',
    autoPolicyStorage: 'Ephemeral storage',
    autoPolicyInode: 'Inodes',
    ...
    autoNoNewAiUsage: 'Summary step · no new AI requests',
    autoConnectingAiSession: 'Connecting AI session…',
    autoNoAiSession: 'AI session unavailable',
    ...
    autoActivityRetrying: 'Retrying API…',
    autoActivityProcessing: 'Processing…',
    autoActivityActive: 'Active…',
    autoHeartbeatActive: 'Active',
    autoHeartbeatWaiting: 'Waiting for response',
    autoHeartbeatStale: 'No recent activity',
    ...
    autoScopeExceededTitle: 'Changed-files cap exceeded',
    autoScopeExceededBody:
      'This round changed {count} files, above the {limit}-file cap. Raise the cap for this workflow and retry, or retry as-is.',
    autoScopeSuggested: 'suggested',
    autoScopeCustom: 'Custom',
    autoRetryWithHigherLimit: 'Retry with new cap',
    autoPlainRetry: 'Plain retry',
    ...
    autoExpandMessage: 'Expand',
    autoCollapseMessage: 'Collapse',
    autoMessageTruncated: 'message truncated (over 200,000 characters)',
    ...
    autoDiffSummaryAria: '{additions} additions, {deletions} deletions, {files} files changed',
    ...
    autoAcceptanceStatusConfirmed: 'Accepted',
    autoAcceptanceStatusRejected: 'Not accepted',
    autoAcceptanceStatusIndeterminate: 'Inconclusive',
    autoAcceptancePathsLabel: 'Required paths',
    autoAcceptanceGatesLabel: 'Mechanical gates',
    autoAcceptanceChecksLabel: 'Semantic checks',
    autoAcceptanceFailedLabel: 'Failed',
    autoAcceptanceUnresolvedLabel: 'Unresolved',
    autoAcceptanceAdvisoryLabel: 'advisory (not counted)',
    autoAcceptanceItemsSuffix: 'items',
    autoAcceptanceSectionScope: 'Scope check',
    autoAcceptanceSectionGates: 'Mechanical gates',
    autoAcceptanceSectionVerifier: 'Verifier findings',
    ...
    ssrfProtectionDisabled: 'Disabled',
    ssrfEmergencyMode: 'Emergency Mode',
    ssrfEmergencyModeWarning:
      'SSRF check disabled, security risk exists. Use only in emergency situations.',
    ssrfDefaultPolicy: 'Default Policy',
    ssrfBlockedPrivateNetworks: 'Blocked Private Networks',
    ssrfBlockedHostnames: 'Blocked Hostnames',
    ssrfCurrentConfig: 'Current Configuration',
    ssrfPortWhitelist: 'Port Whitelist',
    ssrfGlobalAllowlist: 'Global Allowlist',
    ssrfTenantAllowlist: 'Tenant Allowlist',
    ssrfTenantAllowlistCount: '{count} tenants configured',
    ssrfInterceptionStats: 'Interception Statistics',
    ssrfInterceptionLast24h: 'Last 24 Hours',
    ssrfInterceptionLast7d: 'Last 7 Days',
    ssrfInterceptionLast30d: 'Last 30 Days',
    ssrfViewAuditLogs: 'View Detailed Interception Records',
    ssrfResetConfig: 'Reset to Default',
    ssrfResetConfigConfirm: 'Are you sure you want to reset SSRF configuration to default?',
    ssrfResetConfigConfirmItems: 'The following items will be reset:',
    ssrfResetConfigSuccess: 'SSRF configuration has been reset to default',
    ssrfConfigVersionConflict:
      'Configuration has been modified by another admin. Please refresh and try again.',
    ssrfIsCustomized: 'Customized',
    ssrfIsDefault: 'Default',
    ssrfConfigVersion: 'Config Version',
    ssrfConfigSource: 'Config Source',
    ssrfConfigSourceDatabase: 'Database',
    ssrfConfigSourceEnvironment: 'Environment',
  ...
  zh: {
    ...
    notificationIntegrationDesc:
      '管理系统通知渠道和企业协作平台连接。告警接收对象、通知目标及告警等级仍在“配额与告警 → 通知设置”中配置。',
    integrationChannels: '通知渠道',
    integrationCollaboration: '协作平台',
    integrationEmail: '邮件',
    integrationEmailDesc: 'SMTP 服务器连接',
    integrationWebhook: '通用 Webhook',
    integrationWebhookDesc: '全局签名与安全策略',
    integrationDingTalkBot: '钉钉机器人',
    integrationDingTalkBotDesc: '平台投递能力',
    integrationFeishuBot: '飞书机器人',
    integrationFeishuBotDesc: '目标按用户或租户配置',
    integrationFeishuApp: '飞书应用 · 组织同步',
    integrationDingTalkApp: '钉钉应用 · 组织同步',
    integrationWebhookTitle: '通用 Webhook · 全局安全配置',
    integrationDingTalkBotTitle: '钉钉机器人 · 平台投递能力',
    integrationFeishuBotTitle: '飞书机器人 · 平台投递能力',
    integrationSigningSecret: '签名密钥',
    integrationFallbackSecret: '兼容回退签名密钥',
    integrationSecretKeepHint: '留空表示保持已保存密钥不变',
    integrationDeliveryEnabled: '启用投递能力',
    integrationAllowPrivate: '允许私网地址（存在 SSRF 风险）',
    integrationBotBoundary:
      '系统设置页不保存目标 URL。推荐按用户或租户配置密钥，系统级密钥仅作为旧配置兼容回退。',
    integrationFeishuNoConfig: '无需系统配置。请在通知设置中配置每个机器人目标地址和密钥。',
    integrationGoToNotifications: '前往通知设置',
    integrationAutoSync: '启用自动同步',
    integrationTargetTenant: '目标租户',
    integrationSelectTenant: '请选择租户',
    integrationInterval: '同步间隔（分钟）',
    integrationRootDepartment: '根部门 ID',
    integrationMaxRuntime: '最大运行时长（秒）',
    integrationAutoRecovery: '同步卡死时自动恢复',
    integrationSyncNow: '立即同步',
    integrationSyncResult: '最近同步结果',
    integrationSyncConfirm: '确认立即同步所选租户的组织数据吗？',
    integrationSyncSuccess: '组织同步完成',
    integrationTenantRequired: '请先选择有效的目标租户',
    integrationSaved: '配置已保存',
    integrationTestSuccess: '连接测试成功',
    integrationTestFailed: '连接测试失败',
    integrationStatusConfigured: '已配置',
    integrationStatusEnabled: '已启用',
    integrationStatusAvailable: '可用',
    ...
    lastRefresh: '上次刷新',
    lastRefreshTooltipHint: '点击刷新按钮可获取最新数据',
    nextRefresh: '下次刷新',
    noRefreshYet: '暂无刷新记录',
    secondsAgo: '秒前',
    minutesAgo: '分钟前',
    ...
    editPolicyRule: '编辑策略规则',
    editPolicyRuleVersioned: '编辑策略规则（将创建新版本）',
    ruleKey: '规则标识',
    ruleName: '规则名称',
    policyType: '策略类型',
    patternType: '匹配类型',
    ...
    policyVersion: '版本',
    noPolicyRules: '暂无策略规则',
    noPolicyRulesHelp: '创建第一个策略规则以开始使用',
    confirmDisableRule: '确定要禁用此规则吗？',
    confirmEnableRule: '确定要启用此规则吗？',
    ruleToggledSuccess: '规则更新成功',
    ruleToggledFailed: '规则更新失败',
    ruleCreatedSuccess: '策略规则创建成功',
    ruleUpdatedSuccess: '策略规则更新成功（已创建新版本）',
    ruleKeyRequired: '规则标识不能为空',
    ruleNameRequired: '规则名称不能为空',
    policyTypeRequired: '请选择策略类型',
    effectRequired: '请选择效果',
    patternOrValueRequired: '此策略类型需要填写匹配模式或值列表',
    toolNameRequired: 'tool_action 类型需填写工具名称',
    actionRequired: 'tool_action 类型需填写操作名称',
    invalidRegexPattern: '无效的正则表达式',
    contactAdmin: '请联系管理员',
    enterSessionId: '输入会话 ID 以查看策略决策',
    decisionId: '决策 ID',
    decision: '决策',
    regexPatternHelp: '输入有效的正则表达式',

    // Policy Types
    policyTypeModel: '模型',
    policyTypeProvider: '提供商',
    policyTypeToolAction: '工具操作',
    policyTypeFilePath: '文件路径',
    policyTypeCommand: '命令',

    // Policy Effects
    effectAllow: '允许',
    effectDeny: '拒绝',
    effectRequireApproval: '需要审批',

    // Pattern Types
    patternTypeGlob: 'Glob',
    patternTypeRegex: '正则表达式',
    ...
    conversations: '个对话',
    conversationHistoryListCount: '{count} 个对话记录',
    ...
    searchScopedToLoaded: '仅搜索已加载消息，向上加载更多以扩大范围。',
    expand: '展开',
    collapse: '收起',
    autoExpandDetails: '展开详情',
    autoCollapseDetails: '收起详情',
    ...
    enterpriseReport: '企业分析报告',

    // Enterprise Report
    efficiencyMetrics: '效率指标',
    noEfficiencyData: '暂无效率指标数据',
    outputRatio: '输出占比',
    outputRatioHelp: '输出 token 占总 token 的百分比',
    tokensPerRequest: '每请求 Token 数',
    outputPerRequest: '每请求输出数',
    inputOutputRatio: '输入输出比',
    inputOutputRatioHelp: '输入 token 与输出 token 的比值',
    trendAnalysis: '趋势分析',
    noTrendData: '暂无趋势数据',
    direction: '方向',
    directionUp: '上升',
    ...
    daysActive: '活跃天数',
    costRoiNotAvailable: '成本和 ROI 暂不可用',
    costRoiNotAvailableDesc: '当前版本暂不支持成本和 ROI 指标。如需此功能，请联系开发团队。',
    jsonExportPreview: 'JSON 导出预览',
    ...
    deleteCategory: '删除分类',
    categoryName: '分类名称',
    categoryPatterns: '匹配关键字',
    categoryPatternsHint: '输入关键字以匹配项目路径（不区分大小写）',
    categorySortOrder: '排序权重',
    categoryProjectCount: '项目数',
    keywordConflictWarning: '关键字冲突警告',
    impactPreview: '影响预览',
    willAddProjects: '将新增项目',
    willRemoveProjects: '将移除项目',
    categoryDisabled: '已停用',
    enableCategory: '启用分类',
    disableCategory: '停用分类',
    categoryEmptyHint: '暂无分类。创建分类以更好地组织项目。',
    calculating: '计算中...',
    keywordSearchPlaceholder: '搜索分类...',
    categoryModifiedConflict: '分类已被其他用户修改，请刷新后重试。',
    manageCategories: '管理分类',
    categoryNamePlaceholder: '请输入分类名称',
    categoryPatternsPlaceholder: '输入关键字后按回车',
    ...
    projectNameInvalidChars:
      '项目名称包含非法字符。仅允许字母、数字、空格、下划线、连字符和中文字符。',
    projectNamePlaceholder: '请输入项目名称',
    projectNameHint: '最多255个字符。允许：字母、数字、空格、下划线、连字符和中文字符。',
    projectDescription: '描述',
    projectDescriptionPlaceholder: '请输入项目描述',
    projectDescriptionMaxLength: '描述不能超过1000个字符',
    projectShared: '共享',
    projectSharedHint: '开启后，其他用户可以访问此项目。大项目可能需要处理时间。',
    ...
    currentVisibleUsers: '当前可见用户',
    searchUsers: '搜索用户...',
    noUsersFound: '未找到用户',
    noUsersMatchSearch: '没有匹配搜索条件的用户',
    noVisibleUsers: '暂无可见用户',
    ...
    manageUsers: '管理用户',
    userHasActiveSessions: '该用户有 {{count}} 个活跃会话',

    auditAnalysis: '审计分析',
    ssoSettings: 'SSO 设置',
    brandingSettings: '品牌设置',
    logoConfiguration: 'Logo 配置',
    logoUrl: 'Logo URL',
    logoUrlHelper: '输入 Logo 图片的公网 HTTPS URL。推荐尺寸：128x128 像素。',
    logoPreview: 'Logo 预览',
    logoLoadFailed: 'Logo 加载失败',
    systemNameConfiguration: '系统名称配置',
    systemName: '系统名称',
    systemNameHelper: '此名称将显示在登录页标题。',
    welcomeMessageConfiguration: '欢迎语配置',
    welcomeMessageHelper: '配置不同语言的欢迎语。如果某种语言未配置，系统将回退到英文。',
    welcomeMessage: '欢迎语',
    welcomeMessagePlaceholder: '请登录以继续',
    copyrightConfiguration: '版权信息配置',
    copyrightText: '版权信息',
    copyrightHelper: '此信息将显示在登录页页脚。',
    brandingInfoTitle: '品牌配置说明',
    brandingInfoDescription: '品牌设置的修改将反映在登录页上。Logo URL 必须是公网 HTTPS URL。',
    failedToFetchBrandingSettings: '获取品牌设置失败',
    brandingSettingsSaved: '品牌设置保存成功',
    saving: '保存中...',
    ...
    failedToLoadTenants: '加载租户失败',
    noTenantsDescription: '请联系系统管理员分配租户权限。',
    noTenantDescription: '请联系系统管理员配置您的租户。',
    allTenants: '所有租户',
    tenant: '租户',
    ...
    deleteSuccess: '文件已删除',
    deleteFailed: '删除失败',
    confirmDeleteFile: '确定删除此文件吗？',
    fileNotReadable: '你没有权限访问此文件',
    uploadTooLarge: '文件过大',
    uploadTooLargeDesc: '最大允许 {size}MB',
    noFiles: '暂无文件或子目录',
    searchFilesPlaceholder: '搜索文件或文件夹…',
    searchNoResults: '没有匹配的文件或文件夹',
    searchResultsCount: '{count} 个结果',
    searchTruncated: '仅显示前 {count} 个匹配项，请细化关键词以缩小范围。',
    backToCurrentDir: '返回当前目录',
    clearSearch: '清除搜索',
    notWritable: '目录不可写',
    uploadAvatar: '上传头像',
    changeAvatar: '更换头像',
    ...
    testAlertCreated: '测试告警已创建',
    testAlertCreatedDesc: '已创建测试告警，通知正在投递至配置的渠道。',
    testAlertFailed: '发送测试告警失败',
    testAlertCooldown: '请等待 {seconds} 秒后再试',
    ...
    noAlerts: '暂无告警',
    noAlertsDescription: '您当前没有告警。新告警将在此处显示。',
    myAlerts: '我的告警',
    allAlertsMarkedRead: '所有告警已标记为已读',
    ...
    smtpPasswordRequiredForTest: '使用用户名测试连接需要输入密码',
    ...
    // Feishu Integration (Chinese)
    feishuIntegration: '飞书集成',
    feishuAppId: 'App ID',
    feishuAppSecret: 'App Secret',
    syncTargetTenant: '同步目标租户',
    autoSync: '自动同步',
    syncInterval: '同步间隔',
    feishuNotConfigured: '未配置',
    feishuConnected: '已连接',
    feishuInvalid: '配置无效',
    feishuConfiguredUnverified: '待验证',
    feishuConnectionFailed: '连接失败',
    feishuConfigurationError: '配置错误',
    feishuConfigSaved: '飞书配置已保存',
    feishuConfigSavedDesc: '飞书配置已成功保存',
    feishuTestSuccess: '连接测试成功',
    feishuTestFailed: '连接测试失败',
    feishuConfigExists: '当前系统已配置飞书',
    confirmSaveFeishuConfig: '确认飞书配置变更：',
    confirmDeleteFeishuConfig: '确定要删除飞书配置吗？',
    feishuConfigDeleted: '飞书配置已删除',
    feishuConfigDeletedDesc: '飞书配置已删除',
    enterFeishuAppId: '输入飞书 App ID',
    enterFeishuAppSecret: '输入飞书 App Secret',
    enterFeishuTenantId: '输入飞书 Tenant ID（可选）',
    currentSecret: '当前密钥',
    feishuTenantIdHint: '留空则同步到当前租户',
    feishuAutoSyncHint: '自动从飞书同步用户',
    feishuSyncIntervalHint: '范围：1-1440 分钟',
    feishuAppIdRequired: 'App ID 为必填项',
    feishuAppSecretRequired: '新配置或 App ID 变更时需要填写 App Secret',
    feishuSyncIntervalRange: '同步间隔必须在 1 到 1440 分钟之间',
    lastSyncAt: '上次同步',
    show: '显示',
    hide: '隐藏',
    feishuSetupGuide: '飞书设置指南',
    feishuSetupGuide1: '在飞书开放平台创建飞书应用',
    feishuSetupGuide2: '从应用凭证中复制 App ID 和 App Secret',
    feishuSetupGuide3: '配置用户数据访问所需的权限',
    feishuSetupGuide4: '点击"测试连接"验证配置',
    ...
    roiAssumptions: 'ROI 假设',
    roiAppliedAssumptions: '当前基线',
    ...
    roiTrend: 'ROI 趋势',
    roi: 'ROI',
    hourlyLaborCost: '人工小时成本',
    avgTimeSavedPerRequest: '单次请求平均节省时间',
    productivityMultiplier: '生产力倍数',
    currency: '货币',
    costBreakdown: '成本分解',
    roiByUser: '按用户 ROI',
    userIdentifier: '用户',
    ...
    // Efficiency Algorithm V2
    efficiencyAlgorithmVersion: '算法版本',
    efficiencyAlgorithmV1: 'V1.0 (旧版)',
    efficiencyAlgorithmV2: 'V2.0 (任务类型感知)',
    efficiencyAlgorithmAuto: '自动 (A/B 测试)',
    efficiencyTaskType: '任务类型',
    efficiencyTaskTypeAuto: '自动检测',
    efficiencyTaskTypeGeneral: '通用',
    efficiencyTaskTypeCodeGeneration: '代码生成',
    efficiencyTaskTypeDocumentAnalysis: '文档分析',
    efficiencyTaskTypeConversation: '对话',
    efficiencyAppliedTaskType: '应用任务类型',
    efficiencyInferenceConfidence: '推断置信度',
    efficiencyAdvancedFilters: '高级筛选',
    ...
    // Issue #3197: Tenant usage statistics
    tenantUserCount: '用户数',
    tenantTotalUsers: '总用户数',
    tenantTotalTokens: '总 Token 使用量',
    tenantTotalRequests: '总请求量',
    tenantTokenUsage: 'Token 使用',
    tenantRequestUsage: '请求使用',
    tenantCumulativeUsageTooltip: '累计使用量自租户创建以来统计',
    tenantUsageStats: '用量统计',
    tenantViewDetails: '查看详情',
    tenantDetailTitle: '租户详情',
    tenantDailyUsage: '日使用量',
    tenantMonthlyUsage: '月使用量',
    tenantUsageTrend: '用量趋势',
    tenantActiveUsers: '活跃用户',
    tenantNoData: '暂无数据',
    tenantLast30Days: '近 30 天',
    tenantBillingCyclePending: '待设置',
    max: '上限',
    ...
    noProvidersHint: '添加 SSO 提供者以启用单点登录认证。',
    ...
    clientSecretConfirm: '确认客户端密钥',
    enterClientSecretConfirm: '请再次输入客户端密钥',
    clientSecretMismatch: '两次输入的密钥不一致',
    redirectUri: '回调 URI',
    ...
    confirmEnableProvider: '确定要启用此提供者吗？这将恢复 SSO 登录入口。',
    providerEnabled: '提供者已启用',
    providerDisabled: '提供者已禁用',
    enableProviderFailed: '启用提供者失败',
    disableProviderFailed: '禁用提供者失败',
    providerDetail: '提供者详情',
    view: '查看',
    providerNotFound: '提供者未找到',
    failedToLoadProviderDetail: '加载提供者详情失败',
    editProvider: '编辑提供者',
    clientSecretEditHint: '留空保持当前密钥，输入新值更新',
    providerUrls: '提供者 URL',
    predefined: '预定义',
    yes: '是',
    no: '否',
    ...
    apiKeys: 'API 密钥',
    encryptionKeys: '加密密钥',
    encryptionKeyManagement: '加密密钥管理',
    configVersion: '配置版本',
    primaryKeyId: '主密钥 ID',
    syncStatus: '同步状态',
    ...
    inconsistent: '不一致',
    rotateKey: '轮换密钥',
    rotateKeyConfirmation: '密钥轮换确认',
    rotateKeyWarning: '此操作将生成新的加密密钥并标记当前密钥为已弃用。',
    rotateKeyBenefit1: '生成新的加密密钥（符合 Fernet 标准）',
    rotateKeyBenefit2: '将当前密钥标记为已弃用',
    rotateKeyBenefit3: '新密钥将用于后续所有加密操作',
    rotateKeyBenefit4: '现有用户会话和 Agent 连接不受影响',
    currentConfigVersion: '当前配置版本',
    enterRotateToConfirm: '请输入 "ROTATE" 确认',
    rotating: '轮换中...',
    confirmRotate: '确认轮换',
    fingerprint: '指纹',
    lastUsed: '最后使用',
    ...
    securityTips: '安全提示',
    rotateKeyTip1: '密钥轮换将生成新密钥并标记当前密钥为已弃用',
    rotateKeyTip2: '已弃用的密钥仍可用于解密历史数据',
    rotateKeyTip3: '建议定期执行存量密文重加密以确保数据安全',
    rotateKeyTip4: '密钥格式必须符合 Fernet 标准（32 字节 base64）',
    multiReplicaSyncStatus: '多副本同步状态',
    localConfigVersion: '本地配置版本',
    replicaName: '副本名称',
    overallStatus: '整体状态',
    allReplicasSynced: '所有副本已同步',
    someReplicasLagging: '部分副本滞后',
    unknownStatus: '状态未知',
    noReplicasConfigured: '未配置其他副本',
    lagging: '滞后',
    unavailable: '不可用',
    preCheckCiphertext: '预检查密文',
    reEncryptData: '重加密数据',
    reEncryptPreCheck: '重加密预检查',
    checkingCiphertext: '正在检查密文...',
    ciphertextStats: '密文统计',
    totalCiphertexts: '密文总数',
    withKeyIdPrefix: '带 key_id 前缀',
    legacyFormat: '旧格式',
    decryptionTest: '解密测试',
    allCiphertextsDecryptable: '所有密文可以正常解密',
    someCiphertextsUndecryptable: '部分密文无法解密',
    clickToRunPreCheck: '点击"运行预检查"检查密文格式',
    runPreCheck: '运行预检查',
    errorLoadingKeys: '加载加密密钥失败',
    inconsistencyDetected: '检测到环境变量与数据库不一致',
    runMigration: '运行迁移',
    auditLogComingSoon: '审计日志功能即将推出',
    ...
    terminalStopRequestSent: '终端停止请求已发送',
    terminalStopFailed: '终端停止失败',
    remoteOutput: '远程输出',
    viewOutput: '查看输出',
    ...
    autoBackToWorkflowList: '返回工作流列表',
    autoGithubIssue: 'GitHub Issue',
    ...
    autoModel: '模型',
    autoDefaultModel: '默认',
    autoSelectModel: '选择模型…',
    selectModel: '选择模型',
    terminalModelHint: '选择模型以使用其 API Key 配置',
    terminalProtocolHint: '模型将使用对应的 API Key 进行配置。',
    loadingModels: '正在加载模型...',
    noModelsAvailable: '没有可用的模型。请在设置中配置 API Key。',
    autoNoModelsForTool: '该工具尚未配置模型，请先在设置中添加 API Key。',
    autoModelsLoadFailed: '模型加载失败。',
    autoLoadingModels: '正在加载模型…',
    autoSelectToolFirst: '请先选择 Agent 工具以查看可用模型。',
    autoSelectMachineFirst: '请先选择远端机器以查看可用模型。',
    ...
    autoNewBranch: '新分支',
    autoWorktree: 'Worktree',
    autoWorktreeOnlyMultiUser: '多用户模式需要独立的 worktree。',
    ...
    autoRequireFullReviewRounds: '必须跑满固定轮次',
    autoRequireFullReviewRoundsHint: '开启后，计划审查和 PR 审查即使提前通过也不会提前结束。',
    ...
    autoPolicyPanelTitle: 'Agent 运行时与隔离',
    autoPolicyCapabilities: '声明的能力',
    autoPolicyNoCapabilities: '此后端未声明任何隔离能力',
    autoPolicyNotConfigured: '未配置策略',
    autoPolicyNoLimits: '未设置资源限额(策略文件已加载,但各项限额均为空)',
    autoPolicyConfigMissing: '本次运行未找到 agent launcher 策略文件，因此没有记录任何运行时限额。',
    autoPolicyLimit: '限额',
    autoPolicyValue: '值',
    autoPolicyEnforced: '是否强制',
    autoPolicyEnforcedYes: '已强制',
    autoPolicyEnforcedNo: '未强制',
    autoPolicyMemory: '内存',
    autoPolicyPids: '进程数',
    autoPolicyCpu: 'CPU',
    autoPolicyWallClock: '墙钟时间',
    autoPolicyStorage: '临时存储',
    autoPolicyInode: 'Inode 数',
    ...
    autoNoNewAiUsage: '汇总步骤 · 无新增 AI 请求',
    autoConnectingAiSession: '正在连接 AI 会话…',
    autoNoAiSession: 'AI 会话不可用',
    autoSystemStep: '系统步骤',
    // Issue #1531: Activity summary & heartbeat
    ...
    autoActivityRetrying: 'API 重试中…',
    autoActivityProcessing: '处理中…',
    autoActivityActive: '活动中…',
    autoHeartbeatActive: '活动中',
    autoHeartbeatWaiting: '等待响应',
    autoHeartbeatStale: '长时间未收到新活动',
    timeJustNow: '刚刚',
    ...
    autoScopeExceededTitle: '改动文件数超限',
    autoScopeExceededBody:
      '本轮改动 {count} 个文件，超过 {limit} 文件上限。可上调本工作流上限后重试，或按原上限重试。',
    autoScopeSuggested: '建议',
    autoScopeCustom: '自定义',
    autoRetryWithHigherLimit: '带新上限重试',
    autoPlainRetry: '普通重试',
    ...
    autoExpandMessage: '展开',
    autoCollapseMessage: '收起',
    autoMessageTruncated: '消息已截断（超过 20 万字符）',
    ...
    autoDiffSummaryAria: '新增 {additions} 行，删除 {deletions} 行，变更 {files} 个文件',
    autoViewPlan: '查看方案',
    ...
    autoAcceptanceStatusConfirmed: '已通过',
    autoAcceptanceStatusRejected: '未通过',
    autoAcceptanceStatusIndeterminate: '无法判定',
    autoAcceptancePathsLabel: '必需路径',
    autoAcceptanceGatesLabel: '机械门禁',
    autoAcceptanceChecksLabel: '语义检查',
    autoAcceptanceFailedLabel: '未过项',
    autoAcceptanceUnresolvedLabel: '未决项',
    autoAcceptanceAdvisoryLabel: '咨询项(不计入结论)',
    autoAcceptanceItemsSuffix: '项',
    autoAcceptanceSectionScope: '范围检查',
    autoAcceptanceSectionGates: '机制门',
    autoAcceptanceSectionVerifier: '验收器结论',
    ...
    sensitiveKeywordsDesc: '管理内容过滤的敏感关键词',
    addKeyword: '添加关键词',
    keyword: '关键词',
    keywordPlaceholder: '输入敏感关键词',
    keywordHelp: '关键词将用于内容过滤',
    confirmDeleteKeyword: '确定要删除此关键词吗？',
    keywordCreated: '关键词创建成功',
    keywordAlreadyExists: '关键词已存在',
    keywordCreateFailed: '关键词创建失败',
    keywordUpdateFailed: '关键词更新失败',
    keywordDeleteFailed: '关键词删除失败',
    noKeywords: '未配置敏感关键词',
    noPermission: '无权限访问',
    ...
    ssrfProtectionStatus: '防护状态',
    ssrfProtectionEnabled: '已启用',
    ssrfProtectionDisabled: '已禁用',
    ssrfEmergencyMode: '紧急模式',
    ssrfEmergencyModeWarning: 'SSRF 检查已禁用，存在安全风险。请仅在紧急情况下使用。',
    ssrfDefaultPolicy: '默认策略',
    ssrfBlockedPrivateNetworks: '拦截的私有网络',
    ssrfBlockedHostnames: '拦截的主机名',
    ssrfCurrentConfig: '当前配置',
    ssrfPortWhitelist: '端口白名单',
    ssrfGlobalAllowlist: '全局允许列表',
    ssrfTenantAllowlist: '租户允许列表',
    ssrfTenantAllowlistCount: '{count} 个租户已配置',
    ssrfInterceptionStats: '拦截统计',
    ssrfInterceptionLast24h: '近 24 小时',
    ssrfInterceptionLast7d: '近 7 天',
    ssrfInterceptionLast30d: '近 30 天',
    ssrfViewAuditLogs: '查看详细拦截记录',
    ssrfResetConfig: '恢复默认配置',
    ssrfResetConfigConfirm: '确认恢复 SSRF 防护配置为默认值？',
    ssrfResetConfigConfirmItems: '以下配置项将被重置：',
    ssrfResetConfigSuccess: '已恢复默认配置',
    ssrfConfigVersionConflict: '配置已被其他管理员修改，请刷新后重试',
    ssrfIsCustomized: '已自定义',
    ssrfIsDefault: '默认',
    ssrfConfigVersion: '配置版本',
    ssrfConfigSource: '配置来源',
    ssrfConfigSourceDatabase: '数据库',
    ssrfConfigSourceEnvironment: '环境变量',
  ...
  ja: {
    // Common
    notificationIntegration: '通知とインテグレーション',
    notificationIntegrationDesc:
      'システム通知チャネルとコラボレーション接続を管理します。受信者、送信先、警告レベルは「クォータとアラート」の通知設定で管理します。',
    integrationChannels: '通知チャネル',
    integrationCollaboration: 'コラボレーションプラットフォーム',
    integrationEmail: 'メール',
    integrationEmailDesc: 'SMTP サーバー接続',
    integrationWebhook: '汎用 Webhook',
    integrationWebhookDesc: 'グローバル署名とセキュリティポリシー',
    integrationDingTalkBot: 'DingTalk ボット',
    integrationDingTalkBotDesc: 'プラットフォーム配信機能',
    integrationFeishuBot: 'Feishu ボット',
    integrationFeishuBotDesc: '送信先はユーザーまたはテナントごとに設定',
    integrationFeishuApp: 'Feishu アプリ · 組織同期',
    integrationDingTalkApp: 'DingTalk アプリ · 組織同期',
    integrationWebhookTitle: '汎用 Webhook · グローバルセキュリティ',
    integrationDingTalkBotTitle: 'DingTalk ボット · 配信機能',
    integrationFeishuBotTitle: 'Feishu ボット · 配信機能',
    integrationSigningSecret: '署名シークレット',
    integrationFallbackSecret: '互換用フォールバック署名シークレット',
    integrationSecretKeepHint: '保存済みシークレットを維持する場合は空欄',
    integrationDeliveryEnabled: '配信を有効化',
    integrationAllowPrivate: 'プライベートアドレスを許可（SSRF リスク）',
    integrationBotBoundary:
      'このページでは送信先 URL を保存しません。ユーザーまたはテナントのシークレットを優先し、システムシークレットは旧設定のフォールバックにのみ使用します。',
    integrationFeishuNoConfig:
      'システム設定は不要です。通知設定で各ボットの送信先とシークレットを設定してください。',
    integrationGoToNotifications: '通知設定へ移動',
    integrationAutoSync: '自動同期を有効化',
    integrationTargetTenant: '対象テナント',
    integrationSelectTenant: 'テナントを選択',
    integrationInterval: '同期間隔（分）',
    integrationRootDepartment: 'ルート部門 ID',
    integrationMaxRuntime: '最大実行時間（秒）',
    integrationAutoRecovery: '停止した同期を自動復旧',
    integrationSyncNow: '今すぐ同期',
    integrationSyncResult: '最新の同期結果',
    integrationSyncConfirm: '選択したテナントの組織同期を今すぐ実行しますか？',
    integrationSyncSuccess: '組織同期が完了しました',
    integrationTenantRequired: '有効な対象テナントを選択してください',
    integrationSaved: '設定を保存しました',
    integrationTestSuccess: '接続テスト成功',
    integrationTestFailed: '接続テスト失敗',
    integrationStatusConfigured: '設定済み',
    integrationStatusEnabled: '有効',
    integrationStatusAvailable: '利用可能',
    ...
    lastRefresh: '最後の更新',
    lastRefreshTooltipHint: '更新ボタンをクリックして最新データを取得',
    nextRefresh: '次の更新',
    secondsAgo: '秒前',
    minutesAgo: '分前',
    '30s': '30秒',
    ...
    categoryName: 'カテゴリ名',
    categoryPatterns: 'マッチパターン',
    categoryPatternsHint: 'プロジェクトパスにマッチするキーワードを入力（大文字小文字無視）',
    categorySortOrder: 'ソート順',
    categoryProjectCount: 'プロジェクト数',
    keywordConflictWarning: 'キーワード競合警告',
    impactPreview: '影響プレビュー',
    willAddProjects: '追加されるプロジェクト',
    willRemoveProjects: '削除されるプロジェクト',
    categoryDisabled: '無効',
    ...
    projectNameMaxLength: 'プロジェクト名は255文字以内で入力してください',
    projectNameInvalidChars:
      'プロジェクト名に無効な文字が含まれています。文字、数字、スペース、アンダースコア、ハイフン、中国語文字のみ使用できます。',
    projectNamePlaceholder: 'プロジェクト名を入力',
    projectNameHint: '最大255文字。使用可能：文字、数字、スペース、_、-、中国語文字。',
    ...
    noUsersMatchSearch: '検索条件に一致するユーザーがいません',
    noVisibleUsers: '表示ユーザーがいません',
    ...
    selectedUser: '選択済み：{{username}}',
    manageUsers: 'ユーザー管理',
    userHasActiveSessions: 'このユーザーには{{count}}個のアクティブなセッションがあります',

    auditAnalysis: '監査分析',
    ssoSettings: 'SSO設定',
    brandingSettings: 'ブランド設定',
    logoConfiguration: 'ロゴ設定',
    logoUrl: 'ロゴURL',
    logoUrlHelper: 'ロゴ画像の公開HTTPS URLを入力してください。推奨サイズ：128x128ピクセル。',
    logoPreview: 'ロゴプレビュー',
    logoLoadFailed: 'ロゴの読み込みに失敗しました',
    systemNameConfiguration: 'システム名設定',
    systemName: 'システム名',
    systemNameHelper: 'この名前はログインページのタイトルに表示されます。',
    welcomeMessageConfiguration: 'ウェルカムメッセージ設定',
    welcomeMessageHelper:
      '異なる言語でウェルカムメッセージを設定します。言語が設定されていない場合、英語にフォールバックします。',
    welcomeMessage: 'ウェルカムメッセージ',
    welcomeMessagePlaceholder: '続行するにはサインインしてください',
    copyrightConfiguration: '著作権設定',
    copyrightText: '著作権テキスト',
    copyrightHelper: 'このテキストはログインページのフッターに表示されます。',
    brandingInfoTitle: 'ブランド設定情報',
    brandingInfoDescription:
      'ブランド設定の変更はログインページに反映されます。ロゴURLは公開HTTPS URLである必要があります。',
    failedToFetchBrandingSettings: 'ブランド設定の取得に失敗しました',
    brandingSettingsSaved: 'ブランド設定が保存されました',
    saving: '保存中...',
    ...
    noProvidersHint: 'SSOプロバイダーを追加して、ユーザーのシングルサインオン認証を有効にします。',
    ...
    clientSecretConfirm: 'クライアントシークレットの確認',
    enterClientSecretConfirm: 'クライアントシークレットを再入力',
    clientSecretMismatch: 'クライアントシークレットが一致しません',
    ...
    confirmDisableProvider: 'このプロバイダーを無効にしてもよろしいですか？',
    confirmEnableProvider:
      'このプロバイダーを有効にしてもよろしいですか？SSOログインエントリが復元されます。',
    providerEnabled: 'プロバイダーが有効になりました',
    providerDisabled: 'プロバイダーが無効になりました',
    enableProviderFailed: 'プロバイダーの有効化に失敗しました',
    disableProviderFailed: 'プロバイダーの無効化に失敗しました',
    providerDetail: 'プロバイダー詳細',
    view: '表示',
    providerNotFound: 'プロバイダーが見つかりません',
    failedToLoadProviderDetail: 'プロバイダー詳細の読み込みに失敗しました',
    editProvider: 'プロバイダー編集',
    clientSecretEditHint: '空白で現在のシークレットを保持、新しい値を入力して更新',
    providerUrls: 'プロバイダーURL',
    predefined: '事前定義',
    yes: 'はい',
    no: 'いいえ',
    ...
    loadingTenants: 'テナント情報を読み込んでいます...',
    noTenantSelected: 'テナントが選択されていません',
    failedToLoadTenants: 'テナントの読み込みに失敗しました',
    noTenantsDescription: 'システム管理者に連絡してテナント権限を割り当ててください。',
    noTenantDescription: 'システム管理者に連絡してテナントを設定してください。',
    allTenants: 'すべてのテナント',
    tenant: 'テナント',
    ...
    // Policy Rules Management
    policyRule: 'ポリシールール',
    createPolicyRule: 'ポリシールール作成',
    editPolicyRule: 'ポリシールール編集',
    editPolicyRuleVersioned: 'ポリシールール編集（新バージョン作成）',
    ruleKey: 'ルールキー',
    ruleName: 'ルール名',
    policyType: 'ポリシータイプ',
    patternType: 'パターンタイプ',
    ...
    policyVersion: 'バージョン',
    noPolicyRules: 'ポリシールールがありません',
    noPolicyRulesHelp: '最初のポリシールールを作成してください',
    confirmDisableRule: 'このルールを無効にしますか？',
    confirmEnableRule: 'このルールを有効にしますか？',
    ruleToggledSuccess: 'ルールが更新されました',
    ruleToggledFailed: 'ルールの更新に失敗しました',
    ruleCreatedSuccess: 'ポリシールールが作成されました',
    ruleUpdatedSuccess: 'ポリシールールが更新されました（新バージョン作成）',
    ruleKeyRequired: 'ルールキーは必須です',
    ruleNameRequired: 'ルール名は必須です',
    policyTypeRequired: 'ポリシータイプを選択してください',
    effectRequired: '効果を選択してください',
    patternOrValueRequired: 'このポリシータイプにはパターンまたは値リストが必要です',
    toolNameRequired: 'tool_actionタイプにはツール名が必要です',
    actionRequired: 'tool_actionタイプにはアクションが必要です',
    invalidRegexPattern: '無効な正規表現パターン',
    contactAdmin: '管理者に連絡してください',
    enterSessionId: 'セッションIDを入力してポリシー決定を表示',
    decisionId: '決定ID',
    decision: '決定',
    regexPatternHelp: '有効な正規表現を入力',

    // Policy Types
    policyTypeModel: 'モデル',
    policyTypeProvider: 'プロバイダー',
    policyTypeToolAction: 'ツールアクション',
    policyTypeFilePath: 'ファイルパス',
    policyTypeCommand: 'コマンド',

    // Policy Effects
    effectAllow: '許可',
    effectDeny: '拒否',
    effectRequireApproval: '承認必要',
    ...
    rotateKeyTip1: '鍵のローテーションは新しい鍵を生成し、現在の鍵を非推奨としてマークします',
    rotateKeyTip2: '非推奨の鍵も過去のデータを復号化できます',
    rotateKeyTip3: '保存されたデータを定期的に再暗号化してセキュリティを確保することをお勧めします',
    rotateKeyTip4: '鍵の形式はFernet標準（32バイトbase64）に準拠する必要があります',
    multiReplicaSyncStatus: 'マルチレプリカ同期ステータス',
    localConfigVersion: 'ローカル設定バージョン',
    replicaName: 'レプリカ名',
    overallStatus: '全体ステータス',
    allReplicasSynced: 'すべてのレプリカが同期済み',
    someReplicasLagging: '一部のレプリカが遅延中',
    unknownStatus: 'ステータス不明',
    noReplicasConfigured: '他のレプリカが設定されていません',
    lagging: '遅延中',
    unavailable: '利用不可',
    preCheckCiphertext: '暗号文の事前チェック',
    reEncryptData: 'データの再暗号化',
    reEncryptPreCheck: '再暗号化の事前チェック',
    checkingCiphertext: '暗号文をチェック中...',
    ciphertextStats: '暗号文の統計',
    totalCiphertexts: '暗号文の総数',
    withKeyIdPrefix: 'key_idプレフィックス付き',
    legacyFormat: 'レガシー形式',
    decryptionTest: '復号化テスト',
    allCiphertextsDecryptable: 'すべての暗号文が復号化可能',
    someCiphertextsUndecryptable: '一部の暗号文が復号化できません',
    clickToRunPreCheck: '「事前チェックを実行」をクリックして暗号文の形式を確認',
    runPreCheck: '事前チェックを実行',
    errorLoadingKeys: '暗号化鍵の読み込みエラー',
    inconsistencyDetected: '環境変数とデータベースの間で不一致が検出されました',
    runMigration: '移行を実行',
    auditLogComingSoon: '監査ログ機能は近日公開',
    ...
    filterDisabled: '無効',
    piiRedaction: 'PII秘匿',
    highRiskBlock: '高リスクブロック',
    patternRules: 'パターンルール',
    keywordRules: 'キーワードルール',
    cachePerformance: 'キャッシュパフォーマンス',
    cacheHitRate: 'キャッシュヒット率',
    cacheHits: 'キャッシュヒット',
    cacheMisses: 'キャッシュミス',
    cacheSize: 'キャッシュサイズ',
    cacheMaxSize: '最大キャッシュサイズ',
    loadedPatterns: '読み込み済みパターン',
    ...
    conversations: '件の会話',
    conversationHistoryListCount: '{count}件の会話記録',
    noConversationRecords: '会話記録なし',
    timeline: 'タイムライン',
    ...
    expand: '展開',
    collapse: '折りたたむ',
    autoExpandDetails: '詳細を展開',
    autoCollapseDetails: '詳細を折りたたむ',
    ...
    fileNotReadable: 'このファイルにアクセスする権限がありません',
    uploadTooLarge: 'ファイルが大きすぎます',
    uploadTooLargeDesc: '最大サイズは {size}MB です',
    noFiles: 'ファイルもサブディレクトリもありません',
    searchFilesPlaceholder: 'ファイルやフォルダを検索…',
    searchNoResults: '一致するファイルやフォルダはありません',
    searchResultsCount: '{count} 件',
    searchTruncated: '最初の {count} 件のみ表示中。キーワードを絞り込んでください。',
    backToCurrentDir: '現在のディレクトリに戻る',
    clearSearch: '検索をクリア',
    notWritable: 'ディレクトリに書き込めません',
    ...
    roiAssumptions: 'ROI 前提',

    // Enterprise Report
    enterpriseReport: 'エンタープライズレポート',
    efficiencyMetrics: '効率指標',
    noEfficiencyData: '効率データがありません',
    outputRatio: '出力比率',
    outputRatioHelp: '総トークンに対する出力トークンの割合',
    tokensPerRequest: 'リクエストあたりのトークン数',
    outputPerRequest: 'リクエストあたりの出力数',
    inputOutputRatio: '入出力比',
    inputOutputRatioHelp: '入力トークンと出力トークンの比率',
    ...
    roiAssumptionValidation:
      '人件費、生産性倍率、時間短縮には正の値を入力し、通貨ラベルは 1〜8 文字で指定してください。',
    roiDataAnomaly: 'データ異常',
    roiTrend: 'ROI トレンド',
    totalCost: '合計コスト',
    totalSavings: '合計節約額',
    hourlyLaborCost: '時間単価',
    avgTimeSavedPerRequest: '1 リクエストあたりの平均短縮時間',
    productivityMultiplier: '生産性倍率',
    currency: '通貨',
    costBreakdown: 'コスト内訳',
    roiByUser: 'ユーザー別 ROI',
    userIdentifier: 'ユーザー',
    ...
    // Efficiency Algorithm V2
    efficiencyAlgorithmVersion: 'アルゴリズムバージョン',
    efficiencyAlgorithmV1: 'V1.0 (レガシー)',
    efficiencyAlgorithmV2: 'V2.0 (タスクタイプ対応)',
    efficiencyAlgorithmAuto: '自動 (A/B テスト)',
    efficiencyTaskType: 'タスクタイプ',
    efficiencyTaskTypeAuto: '自動検出',
    efficiencyTaskTypeGeneral: '一般',
    efficiencyTaskTypeCodeGeneration: 'コード生成',
    efficiencyTaskTypeDocumentAnalysis: 'ドキュメント分析',
    efficiencyTaskTypeConversation: '会話',
    efficiencyAppliedTaskType: '適用タスクタイプ',
    efficiencyInferenceConfidence: '推論信頼度',
    efficiencyAdvancedFilters: '高度なフィルター',
    ...
    // Issue #3197: Tenant usage statistics
    tenantUserCount: 'ユーザー数',
    tenantTotalUsers: '総ユーザー数',
    tenantTotalTokens: '総トークン使用量',
    tenantTotalRequests: '総リクエスト数',
    tenantTokenUsage: 'トークン使用',
    tenantRequestUsage: 'リクエスト使用',
    tenantCumulativeUsageTooltip: 'テナント作成からの累計使用量',
    tenantUsageStats: '使用統計',
    tenantViewDetails: '詳細を見る',
    tenantDetailTitle: 'テナント詳細',
    tenantDailyUsage: '日次使用量',
    tenantMonthlyUsage: '月次使用量',
    tenantUsageTrend: '使用傾向',
    tenantActiveUsers: 'アクティブユーザー',
    tenantNoData: 'データなし',
    tenantLast30Days: '過去30日',
    tenantBillingCyclePending: '未設定',
    max: '上限',
    ...
    terminalStopRequestSent: 'ターミナル停止リクエストが送信されました',
    terminalStopFailed: 'ターミナルの停止に失敗しました',
    remoteOutput: 'リモート出力',
    viewOutput: '出力を表示',
    ...
    selectModel: 'モデルを選択',
    terminalModelHint: 'API キー設定を使用するモデルを選択してください',
    terminalProtocolHint: 'モデルは対応する API キーで設定されます。',
    loadingModels: 'モデルを読み込み中...',
    noModelsAvailable: '利用可能なモデルがありません。設定で API キーを設定してください。',
    autoNoModelsForTool:
      'このツールにモデルが設定されていません。先に設定で API キーを追加してください。',
    autoModelsLoadFailed: 'モデルの読み込みに失敗しました。',
    ...
    autoWorktree: 'Worktree',
    autoWorktreeOnlyMultiUser: 'マルチユーザーモードでは独立した worktree が必要です。',
    ...
    autoPolicyPanelTitle: 'エージェント・ランタイムと分離',
    autoPolicyCapabilities: '宣言された能力',
    autoPolicyNoCapabilities: 'このバックエンドは分離能力を宣言していません',
    autoPolicyNotConfigured: 'ポリシー未設定',
    autoPolicyNoLimits: 'リソース制限なし(ポリシーファイルは読込済み、制限はすべて未設定)',
    autoPolicyConfigMissing:
      'この実行では agent launcher のポリシーファイルが見つからず、ランタイム制限は記録されませんでした。',
    autoPolicyLimit: 'リミット',
    autoPolicyValue: '値',
    autoPolicyEnforced: '強制',
    autoPolicyEnforcedYes: '強制あり',
    autoPolicyEnforcedNo: '強制なし',
    autoPolicyMemory: 'メモリ',
    autoPolicyPids: 'プロセス数',
    autoPolicyCpu: 'CPU',
    autoPolicyWallClock: '実時間',
    autoPolicyStorage: '一時ストレージ',
    autoPolicyInode: 'Inode 数',
    ...
    autoNoNewAiUsage: '要約ステップ · 新規 AI リクエストなし',
    autoConnectingAiSession: 'AI セッションに接続中…',
    autoNoAiSession: 'AI セッションを利用できません',
    ...
    autoActivityRetrying: 'API再試行中…',
    autoActivityProcessing: '処理中…',
    autoActivityActive: 'アクティブ…',
    autoHeartbeatActive: 'アクティブ',
    autoHeartbeatWaiting: '応答待ち',
    autoHeartbeatStale: '長時間新しいアクティビティなし',
    timeJustNow: 'たった今',
    timeSecondsAgo: '{count}秒前',
    ...
    autoScopeExceededTitle: '変更ファイル数上限超過',
    autoScopeExceededBody:
      '今ラウンドで {count} ファイルを変更し、{limit} ファイル上限を超えました。本ワークフローの上限を引き上げて再試行するか、そのまま再試行できます。',
    autoScopeSuggested: '推奨',
    autoScopeCustom: 'カスタム',
    autoRetryWithHigherLimit: '新上限で再試行',
    autoPlainRetry: '通常再試行',
    ...
    autoExpandMessage: '展開',
    autoCollapseMessage: '折りたたむ',
    autoMessageTruncated: 'メッセージは切り詰められました（20万文字超）',
    ...
    autoDiffSummaryAria: '{additions} 行追加、{deletions} 行削除、{files} ファイル変更',
    autoViewPlan: 'プランを見る',
    ...
    autoAcceptanceStatusConfirmed: '受理されました',
    autoAcceptanceStatusRejected: '受理されませんでした',
    autoAcceptanceStatusIndeterminate: '判定不能',
    autoAcceptancePathsLabel: '必須パス',
    autoAcceptanceGatesLabel: '機械ゲート',
    autoAcceptanceChecksLabel: '意味チェック',
    autoAcceptanceFailedLabel: '未達成項目',
    autoAcceptanceUnresolvedLabel: '未確定項目',
    autoAcceptanceAdvisoryLabel: '参考(判定外)',
    autoAcceptanceItemsSuffix: '項',
    autoAcceptanceSectionScope: 'スコープ検証',
    autoAcceptanceSectionGates: '機械ゲート',
    autoAcceptanceSectionVerifier: '検証エージェントの所見',
    autoAcceptanceOverrideConfirm:
    ...
    // Feishu Integration (Japanese)
    feishuIntegration: 'Feishu 連携',
    feishuAppId: 'App ID',
    feishuAppSecret: 'App Secret',
    syncTargetTenant: '同期先テナント',
    autoSync: '自動同期',
    syncInterval: '同期間隔',
    feishuNotConfigured: '未設定',
    feishuConnected: '接続済み',
    feishuInvalid: '設定無効',
    feishuConfiguredUnverified: '検証待ち',
    feishuConnectionFailed: '接続失敗',
    feishuConfigurationError: '設定エラー',
    feishuConfigSaved: 'Feishu 設定を保存',
    feishuConfigSavedDesc: 'Feishu 設定が正常に保存されました',
    feishuTestSuccess: '接続テスト成功',
    feishuTestFailed: '接続テスト失敗',
    feishuConfigExists: '現在システムに Feishu 設定があります',
    confirmSaveFeishuConfig: 'Feishu 設定変更を確認：',
    confirmDeleteFeishuConfig: 'Feishu 設定を削除しますか？',
    feishuConfigDeleted: 'Feishu 設定を削除',
    feishuConfigDeletedDesc: 'Feishu 設定が削除されました',
    enterFeishuAppId: 'Feishu App ID を入力',
    enterFeishuAppSecret: 'Feishu App Secret を入力',
    enterFeishuTenantId: 'Feishu Tenant ID を入力（任意）',
    currentSecret: '現在のシークレット',
    feishuTenantIdHint: '空欄の場合は現在のテナントに同期',
    feishuAutoSyncHint: 'Feishu からユーザーを自動同期',
    feishuSyncIntervalHint: '範囲：1-1440 分',
    feishuAppIdRequired: 'App ID は必須です',
    feishuAppSecretRequired: '新規設定または App ID 変更時は App Secret が必要です',
    feishuSyncIntervalRange: '同期間隔は1〜1440分の範囲で指定してください',
    lastSyncAt: '最終同期',
    show: '表示',
    hide: '非表示',
    feishuSetupGuide: 'Feishu 設定ガイド',
    feishuSetupGuide1: 'Feishu オープンプラットフォームで Feishu アプリを作成',
    feishuSetupGuide2: 'アプリの認証情報から App ID と App Secret をコピー',
    feishuSetupGuide3: 'ユーザーデータアクセスに必要な権限を設定',
    feishuSetupGuide4: '「接続テスト」をクリックして設定を検証',
  },
  ko: {
    // Common
    notificationIntegration: '알림 및 연동',
    notificationIntegrationDesc:
      '시스템 알림 채널과 협업 플랫폼 연결을 관리합니다. 수신자, 대상 및 경고 수준은 할당량 및 알림의 알림 설정에서 관리합니다.',
    integrationChannels: '알림 채널',
    integrationCollaboration: '협업 플랫폼',
    integrationEmail: '이메일',
    integrationEmailDesc: 'SMTP 서버 연결',
    integrationWebhook: '일반 Webhook',
    integrationWebhookDesc: '전역 서명 및 보안 정책',
    integrationDingTalkBot: 'DingTalk 봇',
    integrationDingTalkBotDesc: '플랫폼 전송 기능',
    integrationFeishuBot: 'Feishu 봇',
    integrationFeishuBotDesc: '대상은 사용자 또는 테넌트별로 설정',
    integrationFeishuApp: 'Feishu 앱 · 조직 동기화',
    integrationDingTalkApp: 'DingTalk 앱 · 조직 동기화',
    integrationWebhookTitle: '일반 Webhook · 전역 보안',
    integrationDingTalkBotTitle: 'DingTalk 봇 · 전송 기능',
    integrationFeishuBotTitle: 'Feishu 봇 · 전송 기능',
    integrationSigningSecret: '서명 비밀키',
    integrationFallbackSecret: '호환용 대체 서명 비밀키',
    integrationSecretKeepHint: '저장된 비밀키를 유지하려면 비워 두세요',
    integrationDeliveryEnabled: '전송 활성화',
    integrationAllowPrivate: '사설 주소 허용(SSRF 위험)',
    integrationBotBoundary:
      '이 페이지는 대상 URL을 저장하지 않습니다. 사용자 또는 테넌트 비밀키를 우선하고 시스템 비밀키는 이전 설정의 대체 수단으로만 사용합니다.',
    integrationFeishuNoConfig:
      '시스템 설정이 필요하지 않습니다. 알림 설정에서 각 봇 대상과 비밀키를 설정하세요.',
    integrationGoToNotifications: '알림 설정으로 이동',
    integrationAutoSync: '자동 동기화 활성화',
    integrationTargetTenant: '대상 테넌트',
    integrationSelectTenant: '테넌트 선택',
    integrationInterval: '동기화 간격(분)',
    integrationRootDepartment: '루트 부서 ID',
    integrationMaxRuntime: '최대 실행 시간(초)',
    integrationAutoRecovery: '중단된 동기화 자동 복구',
    integrationSyncNow: '지금 동기화',
    integrationSyncResult: '최근 동기화 결과',
    integrationSyncConfirm: '선택한 테넌트의 조직 동기화를 지금 실행할까요?',
    integrationSyncSuccess: '조직 동기화 완료',
    integrationTenantRequired: '유효한 대상 테넌트를 선택하세요',
    integrationSaved: '설정이 저장되었습니다',
    integrationTestSuccess: '연결 테스트 성공',
    integrationTestFailed: '연결 테스트 실패',
    integrationStatusConfigured: '설정됨',
    integrationStatusEnabled: '활성화됨',
    integrationStatusAvailable: '사용 가능',
    ...
    lastRefreshTooltipHint: '새로고침 버튼을 클릭하여 최신 데이터를 가져오세요',
    nextRefresh: '다음 새로고침',
    secondsAgo: '초 전',
    minutesAgo: '분 전',
    '30s': '30초',
    ...
    categoryPatterns: '매치 패턴',
    categoryPatternsHint: '프로젝트 경로와 매치할 키워드 입력 (대소문자 무시)',
    categorySortOrder: '정렬 순서',
    categoryProjectCount: '프로젝트 수',
    keywordConflictWarning: '키워드 충돌 경고',
    impactPreview: '영향 미리보기',
    willAddProjects: '추가될 프로젝트',
    willRemoveProjects: '제거될 프로젝트',
    categoryDisabled: '비활성화',
    ...
    noCategoriesFound: '카테고리를 찾을 수 없음',
    uncategorized: '미분류',
    projectPath: '프로젝트 경로',
    ...
    projectNameMaxLength: '프로젝트 이름은 255자 이하여야 합니다',
    projectNameInvalidChars:
      '프로젝트 이름에 유효하지 않은 문자가 포함되어 있습니다. 문자, 숫자, 공백, 밑줄, 하이픈, 한자만 사용 가능합니다.',
    projectNamePlaceholder: '프로젝트 이름 입력',
    projectNameHint: '최대 255자. 사용 가능: 문자, 숫자, 공백, _ , - 및 한자.',
    ...
    currentVisibleUsers: '현재 표시되는 사용자',
    searchUsers: '사용자 검색...',
    noUsersFound: '사용자를 찾을 수 없음',
    noUsersMatchSearch: '검색 조건과 일치하는 사용자가 없습니다',
    noVisibleUsers: '표시되는 사용자가 없습니다',
    ...
    selectedUser: '선택됨: {{username}}',
    manageUsers: '사용자 관리',
    userHasActiveSessions: '이 사용자는 {{count}}개의 활성 세션이 있습니다',

    auditAnalysis: '감사 분석',
    ssoSettings: 'SSO 설정',
    brandingSettings: '브랜드 설정',
    logoConfiguration: '로고 설정',
    logoUrl: '로고 URL',
    logoUrlHelper: '로고 이미지의 공개 HTTPS URL을 입력하세요. 권장 크기: 128x128 픽셀.',
    logoPreview: '로고 미리보기',
    logoLoadFailed: '로고 로드 실패',
    systemNameConfiguration: '시스템 이름 설정',
    systemName: '시스템 이름',
    systemNameHelper: '이 이름은 로그인 페이지 제목에 표시됩니다.',
    welcomeMessageConfiguration: '환영 메시지 설정',
    welcomeMessageHelper:
      '다양한 언어로 환영 메시지를 설정합니다. 언어가 설정되지 않은 경우 영어로 대체됩니다.',
    welcomeMessage: '환영 메시지',
    welcomeMessagePlaceholder: '계속하려면 로그인하세요',
    copyrightConfiguration: '저작권 설정',
    ...
    selectTenant: '테넌트 선택',
    selectTenantPlaceholder: '테넌트 선택',
    loadingTenants: '테넌트 정보를 불러오는 중...',
    noTenantSelected: '선택된 테넌트 없음',
    failedToLoadTenants: '테넌트 로드 실패',
    noTenantsDescription: '시스템 관리자에게 연락하여 테넌트 권한을 할당받으세요.',
    noTenantDescription: '시스템 관리자에게 연락하여 테넌트를 설정하세요.',
    allTenants: '모든 테넌트',
    tenant: '테넌트',
    ...
    noProvidersHint: 'SSO 제공업체를 추가하여 사용자의 단일 로그인 인증을 활성화하세요.',
    availableProviders: '사용 가능한 제공업체',
    addProvider: '제공업체 추가',
    providerName: '제공업체 이름',
    providerType: '제공업체 유형',
    selectProvider: '제공업체 선택',
    enterProviderName: '제공업체 이름 입력',
    clientId: '클라이언트 ID',
    enterClientId: '클라이언트 ID 입력',
    clientSecret: '클라이언트 비밀번호',
    enterClientSecret: '클라이언트 비밀번호 입력',
    clientSecretConfirm: '클라이언트 비밀번호 확인',
    enterClientSecretConfirm: '클라이언트 비밀번호 재입력',
    clientSecretMismatch: '클라이언트 비밀번호가 일치하지 않습니다',
    redirectUri: '리디렉션 URI',
    enterRedirectUri: '리디렉션 URI 입력',
    scope: '범위',
    customProviderUrls: '사용자 지정 제공업체 URL',
    authorizationUrl: '인증 URL',
    tokenUrl: '토큰 URL',
    userinfoUrl: '사용자 정보 URL',
    issuerUrl: 'Issuer URL',
    registerProvider: '제공업체 등록',
    register: '등록',
    disable: '비활성화',
    clientIdRequired: '클라이언트 ID는 필수입니다',
    clientSecretRequired: '클라이언트 비밀번호는 필수입니다',
    providerNameRequired: '제공업체 이름은 필수입니다',
    registerFailed: '제공업체 등록 실패',
    providerRegistered: '제공업체가 성공적으로 등록되었습니다',
    confirmDisableProvider: '이 제공업체를 비활성화하겠습니까?',
    confirmEnableProvider: '이 제공업체를 활성화하겠습니까? SSO 로그인 항목이 복원됩니다.',
    providerEnabled: '제공업체가 활성화되었습니다',
    providerDisabled: '제공업체가 비활성화되었습니다',
    enableProviderFailed: '제공업체 활성화 실패',
    disableProviderFailed: '제공업체 비활성화 실패',
    providerDetail: '제공업체 상세',
    view: '보기',
    providerNotFound: '제공업체를 찾을 수 없음',
    failedToLoadProviderDetail: '제공업체 상세 로드 실패',
    editProvider: '제공업체 편집',
    clientSecretEditHint: '공백으로 현재 비밀번호 유지, 새 값 입력하여 업데이트',
    providerUrls: '제공업체 URL',
    predefined: '사전 정의',
    yes: '예',
    no: '아니오',
    ...
    // Policy Rules Management
    policyRule: '정책 규칙',
    createPolicyRule: '정책 규칙 생성',
    editPolicyRule: '정책 규칙 편집',
    editPolicyRuleVersioned: '정책 규칙 편집 (새 버전 생성)',
    ruleKey: '규칙 키',
    ruleName: '규칙 이름',
    policyType: '정책 유형',
    patternType: '패턴 유형',
    ...
    policyVersion: '버전',
    noPolicyRules: '정책 규칙이 없습니다',
    noPolicyRulesHelp: '첫 번째 정책 규칙을 생성하세요',
    confirmDisableRule: '이 규칙을 비활성화하시겠습니까?',
    confirmEnableRule: '이 규칙을 활성화하시겠습니까?',
    ruleToggledSuccess: '규칙이 업데이트되었습니다',
    ruleToggledFailed: '규칙 업데이트 실패',
    ruleCreatedSuccess: '정책 규칙이 생성되었습니다',
    ruleUpdatedSuccess: '정책 규칙이 업데이트되었습니다 (새 버전 생성)',
    ruleKeyRequired: '규칙 키는 필수입니다',
    ruleNameRequired: '규칙 이름은 필수입니다',
    policyTypeRequired: '정책 유형을 선택하세요',
    effectRequired: '효과를 선택하세요',
    patternOrValueRequired: '이 정책 유형에는 패턴 또는 값 목록이 필요합니다',
    toolNameRequired: 'tool_action 유형에는 도구 이름이 필요합니다',
    actionRequired: 'tool_action 유형에는 작업이 필요합니다',
    invalidRegexPattern: '잘못된 정규식 패턴',
    contactAdmin: '관리자에게 문의하세요',
    enterSessionId: '정책 결정을 보려면 세션 ID를 입력하세요',
    decisionId: '결정 ID',
    decision: '결정',
    regexPatternHelp: '유효한 정규식 입력',

    // Policy Types
    policyTypeModel: '모델',
    policyTypeProvider: '제공자',
    policyTypeToolAction: '도구 작업',
    policyTypeFilePath: '파일 경로',
    policyTypeCommand: '명령',

    // Policy Effects
    effectAllow: '허용',
    effectDeny: '거부',
    effectRequireApproval: '승인 필요',
    ...
    lastUsed: '최종 사용',
    keysList: '키 목록',
    operationHistory: '작업 기록',
    securityTips: '보안 팁',
    rotateKeyTip1: '키 순환은 새 키를 생성하고 현재 키를 사용되지 않음으로 표시합니다',
    rotateKeyTip2: '사용되지 않는 키도 과거 데이터를 해독할 수 있습니다',
    rotateKeyTip3: '보안을 위해 저장된 데이터를 정기적으로 재암호화하는 것이 좋습니다',
    rotateKeyTip4: '키 형식은 Fernet 표준(32바이트 base64)을 준수해야 합니다',
    multiReplicaSyncStatus: '다중 복제본 동기화 상태',
    localConfigVersion: '로컬 구성 버전',
    replicaName: '복제본 이름',
    overallStatus: '전체 상태',
    allReplicasSynced: '모든 복제본 동기화됨',
    someReplicasLagging: '일부 복제본 지연 중',
    unknownStatus: '알 수 없는 상태',
    noReplicasConfigured: '다른 복제본이 구성되지 않음',
    lagging: '지연 중',
    unavailable: '사용할 수 없음',
    preCheckCiphertext: '암호문 사전 확인',
    reEncryptData: '데이터 재암호화',
    reEncryptPreCheck: '재암호화 사전 확인',
    checkingCiphertext: '암호문 확인 중...',
    ciphertextStats: '암호문 통계',
    totalCiphertexts: '총 암호문',
    withKeyIdPrefix: 'key_id 접두사 포함',
    legacyFormat: '레거시 형식',
    decryptionTest: '복호화 테스트',
    allCiphertextsDecryptable: '모든 암호문 복호화 가능',
    someCiphertextsUndecryptable: '일부 암호문을 복호화할 수 없음',
    clickToRunPreCheck: '"사전 확인 실행"을 클릭하여 암호문 형식 확인',
    runPreCheck: '사전 확인 실행',
    errorLoadingKeys: '암호화 키 로드 오류',
    inconsistencyDetected: '환경 변수와 데이터베이스 간 불일치가 감지됨',
    runMigration: '마이그레이션 실행',
    auditLogComingSoon: '감사 로그 기능 출시 예정',
    ...
    piiRedaction: 'PII 익명화',
    highRiskBlock: '고위험 차단',
    patternRules: '패턴 규칙',
    keywordRules: '키워드 규칙',
    ...
    cacheMisses: '캐시 미스',
    cacheSize: '캐시 크기',
    cacheMaxSize: '최대 캐시 크기',
    loadedPatterns: '로드된 패턴',
    ...
    conversations: '개 대화',
    conversationHistoryListCount: '{count}개 대화 기록',
    noConversationRecords: '대화 기록 없음',
    timeline: '타임라인',
    latencyCurve: '지연 곡선',
    latency: '지연',
    ...
    loadOlder: '이전 불러오기',
    refreshToLatest: '최신으로 새로고침',
    searchScopedToLoaded: '불러온 메시지만 검색 중. 이전을 불러와 범위를 넓히세요.',
    expand: '펼치기',
    collapse: '접기',
    autoExpandDetails: '세부정보 펼치기',
    autoCollapseDetails: '세부정보 접기',
    ...
    fileNotReadable: '이 파일에 접근할 권한이 없습니다',
    uploadTooLarge: '파일이 너무 큽니다',
    uploadTooLargeDesc: '최대 크기는 {size}MB입니다',
    noFiles: '파일이나 하위 디렉터리가 없습니다',
    searchFilesPlaceholder: '파일 또는 폴더 검색…',
    searchNoResults: '일치하는 파일이나 폴더가 없습니다',
    searchResultsCount: '{count}개 결과',
    searchTruncated: '처음 {count}개만 표시됩니다. 검색어를 구체화하세요.',
    backToCurrentDir: '현재 디렉터리로 돌아가기',
    clearSearch: '검색 지우기',
    notWritable: '디렉터리에 쓸 수 없습니다',
    ...
    roiAssumptions: 'ROI 가정',

    // Enterprise Report
    enterpriseReport: '기업 분석 보고서',
    efficiencyMetrics: '효율성 지표',
    noEfficiencyData: '효율성 데이터가 없습니다',
    outputRatio: '출력 비율',
    outputRatioHelp: '총 토큰 대비 출력 토큰 비율',
    tokensPerRequest: '요청당 토큰 수',
    outputPerRequest: '요청당 출력 수',
    inputOutputRatio: '입출력 비율',
    inputOutputRatioHelp: '입력 토큰과 출력 토큰의 비율',
    ...
    daysActive: '활성 일수',
    costRoiNotAvailable: '비용 및 ROI를 사용할 수 없습니다',
    costRoiNotAvailableDesc:
      '현재 버전에서는 비용 및 ROI 지표가 지원되지 않습니다. 이 기능이 필요하면 개발팀에 문의하세요.',
    jsonExportPreview: 'JSON 내보내기 미리보기',

    roiAppliedAssumptions: '현재 기준',
    roiAssumptionsHelp:
    ...
    roiAssumptionValidation:
      '인건비, 생산성 배수, 절감 시간에는 양수를 입력하고 통화 라벨은 1~8자로 지정하세요.',
    roiDataAnomaly: '데이터 이상',
    roiTrend: 'ROI 추세',
    totalCost: '총 비용',
    totalSavings: '총 절감액',
    hourlyLaborCost: '시간당 인건비',
    avgTimeSavedPerRequest: '요청당 평균 절감 시간',
    productivityMultiplier: '생산성 배수',
    currency: '통화',
    costBreakdown: '비용 내역',
    roiByUser: '사용자별 ROI',
    userIdentifier: '사용자',
    ...
    // Efficiency Algorithm V2
    efficiencyAlgorithmVersion: '알고리즘 버전',
    efficiencyAlgorithmV1: 'V1.0 (레거시)',
    efficiencyAlgorithmV2: 'V2.0 (작업 유형 인식)',
    efficiencyAlgorithmAuto: '자동 (A/B 테스트)',
    efficiencyTaskType: '작업 유형',
    efficiencyTaskTypeAuto: '자동 감지',
    efficiencyTaskTypeGeneral: '일반',
    efficiencyTaskTypeCodeGeneration: '코드 생성',
    efficiencyTaskTypeDocumentAnalysis: '문서 분석',
    efficiencyTaskTypeConversation: '대화',
    efficiencyAppliedTaskType: '적용 작업 유형',
    efficiencyInferenceConfidence: '추론 신뢰도',
    efficiencyAdvancedFilters: '고급 필터',
    ...
    // Issue #3197: Tenant usage statistics
    tenantUserCount: '사용자 수',
    tenantTotalUsers: '총 사용자 수',
    tenantTotalTokens: '총 토큰 사용량',
    tenantTotalRequests: '총 요청 수',
    tenantTokenUsage: '토큰 사용',
    tenantRequestUsage: '요청 사용',
    tenantCumulativeUsageTooltip: '테넌트 생성 이후 누적 사용량',
    tenantUsageStats: '사용 통계',
    tenantViewDetails: '상세 보기',
    tenantDetailTitle: '테넌트 상세',
    tenantDailyUsage: '일일 사용량',
    tenantMonthlyUsage: '월간 사용량',
    tenantUsageTrend: '사용 추세',
    tenantActiveUsers: '활성 사용자',
    tenantNoData: '데이터 없음',
    tenantLast30Days: '최근 30일',
    tenantBillingCyclePending: '미설정',
    max: '최대',
    ...
    terminalStopRequestSent: '터미널 중지 요청이 전송되었습니다',
    terminalStopFailed: '터미널 중지 실패',
    remoteOutput: '원격 출력',
    viewOutput: '출력 보기',
    ...
    autoBackToWorkflowList: '워크플로우 목록으로',
    autoGithubIssue: 'GitHub Issue',
    ...
    autoModel: '모델',
    autoDefaultModel: '기본',
    autoSelectModel: '모델 선택…',
    selectModel: '모델 선택',
    terminalModelHint: 'API 키 설정을 사용할 모델을 선택하세요',
    terminalProtocolHint: '모델이 해당 API 키로 구성됩니다.',
    loadingModels: '모델을 불러오는 중...',
    noModelsAvailable: '사용 가능한 모델이 없습니다. 설정에서 API 키를 구성하세요.',
    autoNoModelsForTool: '이 도구에 구성된 모델이 없습니다. 먼저 설정에서 API 키를 추가하세요.',
    autoModelsLoadFailed: '모델을 불러오지 못했습니다.',
    autoLoadingModels: '모델을 불러오는 중…',
    autoSelectToolFirst: '에이전트 도구를 선택하면 사용 가능한 모델이 표시됩니다.',
    autoSelectMachineFirst: '원격 머신을 선택하면 사용 가능한 모델이 표시됩니다.',
    ...
    autoNewBranch: '새 브랜치',
    autoWorktree: 'Worktree',
    autoWorktreeOnlyMultiUser: '다중 사용자 모드에서는 격리된 worktree가 필요합니다.',
    ...
    autoPolicyPanelTitle: '에이전트 런타임 및 격리',
    autoPolicyCapabilities: '선언된 기능',
    autoPolicyNoCapabilities: '이 백엔드는 격리 기능을 선언하지 않았습니다',
    autoPolicyNotConfigured: '정책 미구성',
    autoPolicyNoLimits: '리소스 제한 없음(정책 파일은 로드되었으나 모든 제한이 미설정)',
    autoPolicyConfigMissing:
      '이번 실행에서는 agent launcher 정책 파일을 찾지 못해 런타임 제한이 기록되지 않았습니다.',
    autoPolicyLimit: '제한',
    autoPolicyValue: '값',
    autoPolicyEnforced: '적용 여부',
    autoPolicyEnforcedYes: '적용됨',
    autoPolicyEnforcedNo: '적용 안 됨',
    autoPolicyMemory: '메모리',
    autoPolicyPids: '프로세스 수',
    autoPolicyCpu: 'CPU',
    autoPolicyWallClock: '실행 시간',
    autoPolicyStorage: '임시 스토리지',
    autoPolicyInode: 'Inode 수',
    ...
    autoNoNewAiUsage: '요약 단계 · 새 AI 요청 없음',
    autoConnectingAiSession: 'AI 세션 연결 중…',
    autoNoAiSession: 'AI 세션을 사용할 수 없음',
    ...
    autoActivityRetrying: 'API 재시도 중…',
    autoActivityProcessing: '처리 중…',
    autoActivityActive: '활성…',
    autoHeartbeatActive: '활성',
    autoHeartbeatWaiting: '응답 대기',
    autoHeartbeatStale: '오랫동안 새 활동 없음',
    timeJustNow: '방금',
    timeSecondsAgo: '{count}초 전',
    ...
    autoScopeExceededTitle: '변경 파일 수 한도 초과',
    autoScopeExceededBody:
      '이번 라운드에서 {count}개 파일을 변경해 {limit} 파일 한도를 초과했습니다. 이 워크플로의 한도를 올려 재시도하거나 그대로 재시도할 수 있습니다.',
    autoScopeSuggested: '권장',
    autoScopeCustom: '사용자 지정',
    autoRetryWithHigherLimit: '새 한도로 재시도',
    autoPlainRetry: '일반 재시도',
    ...
    autoExpandMessage: '펼치기',
    autoCollapseMessage: '접기',
    autoMessageTruncated: '메시지가 잘렸습니다(20만 자 초과)',
    ...
    autoDiffSummaryAria: '{additions}줄 추가, {deletions}줄 삭제, {files}개 파일 변경',
    autoViewPlan: '계획 보기',
    ...
    autoAcceptanceStatusConfirmed: '승인됨',
    autoAcceptanceStatusRejected: '승인되지 않음',
    autoAcceptanceStatusIndeterminate: '판단 불가',
    autoAcceptancePathsLabel: '필수 경로',
    autoAcceptanceGatesLabel: '기계 게이트',
    autoAcceptanceChecksLabel: '의미 검증',
    autoAcceptanceFailedLabel: '미달 항목',
    autoAcceptanceUnresolvedLabel: '미확정 항목',
    autoAcceptanceAdvisoryLabel: '참고(판정 제외)',
    autoAcceptanceItemsSuffix: '항목',
    autoAcceptanceSectionScope: '범위 검증',
    autoAcceptanceSectionGates: '기계 게이트',
    autoAcceptanceSectionVerifier: '검증 에이전트 소견',
    autoAcceptanceOverrideConfirm:
    ...
    // Feishu Integration (Korean)
    feishuIntegration: 'Feishu 연동',
    feishuAppId: 'App ID',
    feishuAppSecret: 'App Secret',
    syncTargetTenant: '동기화 대상 테넌트',
    autoSync: '자동 동기화',
    syncInterval: '동기화 간격',
    feishuNotConfigured: '미설정',
    feishuConnected: '연결됨',
    feishuInvalid: '설정 무효',
    feishuConfiguredUnverified: '검증 대기',
    feishuConnectionFailed: '연결 실패',
    feishuConfigurationError: '설정 오류',
    feishuConfigSaved: 'Feishu 설정 저장',
    feishuConfigSavedDesc: 'Feishu 설정이 저장되었습니다',
    feishuTestSuccess: '연결 테스트 성공',
    feishuTestFailed: '연결 테스트 실패',
    feishuConfigExists: '현재 시스템에 Feishu 설정이 있습니다',
    confirmSaveFeishuConfig: 'Feishu 설정 변경 확인：',
    confirmDeleteFeishuConfig: 'Feishu 설정을 삭제하시겠습니까?',
    feishuConfigDeleted: 'Feishu 설정 삭제',
    feishuConfigDeletedDesc: 'Feishu 설정이 삭제되었습니다',
    enterFeishuAppId: 'Feishu App ID 입력',
    enterFeishuAppSecret: 'Feishu App Secret 입력',
    enterFeishuTenantId: 'Feishu Tenant ID 입력（선택）',
    currentSecret: '현재 시크릿',
    feishuTenantIdHint: '비워두면 현재 테넌트에 동기화',
    feishuAutoSyncHint: 'Feishu에서 사용자 자동 동기화',
    feishuSyncIntervalHint: '범위：1-1440분',
    feishuAppIdRequired: 'App ID는 필수입니다',
    feishuAppSecretRequired: '신규 설정 또는 App ID 변경 시 App Secret이 필요합니다',
    feishuSyncIntervalRange: '동기화 간격은 1~1440분 범위로 지정하세요',
    lastSyncAt: '최종 동기화',
    show: '표시',
    hide: '숨기기',
    feishuSetupGuide: 'Feishu 설정 가이드',
    feishuSetupGuide1: 'Feishu 오픈 플랫폼에서 Feishu 앱 생성',
    feishuSetupGuide2: '앱 자격 증명에서 App ID와 App Secret 복사',
    feishuSetupGuide3: '사용자 데이터 접근에 필요한 권한 설정',
    feishuSetupGuide4: '「연결 테스트」를 클릭하여 설정 검증',
  },
};
