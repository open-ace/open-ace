...
const translations: Record<Language, Translations> = {
  en: {
    ...
    autoOriginalDefinition: 'Original Definition',
    autoFinalPlan: 'Final Plan',
    autoReviewSummaryLabel: 'PR Review Summary',
    autoLatestCodeChanges: 'Latest Code Changes',
    ...
    autoStartedAt: 'Started At',
    autoDuration: 'Duration',
    autoBannerPlanningTimeout: 'Planning has timed out. Extend the planning window or stop this workflow.',
  ...
  zh: {
    ...
    autoOriginalDefinition: '查看原始定义',
    autoFinalPlan: '最终方案',
    autoReviewSummaryLabel: 'PR 评审总结',
    autoLatestCodeChanges: '最终代码变更',
  ...
  ja: {
    ...
    autoOriginalDefinition: '元の要件',
    autoFinalPlan: '最終プラン',
    autoReviewSummaryLabel: 'PRレビュー要約',
    autoLatestCodeChanges: '最新のコード変更',
    autoSummarySection: '要約',
    autoOutputSection: '出力',
    autoReviewSection: 'レビュー',
    autoSessionTrace: 'セッション / トレース',
    autoActionsSection: '操作',
    autoActivity: 'アクティビティ',
  ...
  ko: {
    ...
    autoOriginalDefinition: '원본 요구사항',
    autoFinalPlan: '최종 계획',
    autoReviewSummaryLabel: 'PR 리뷰 요약',
    autoLatestCodeChanges: '최종 코드 변경',
