...
const translations: Record<Language, Translations> = {
  ...
  zh: {
    ...
    autoWorkflowDefinition: '工作流原始定义',
    autoBatchInfo: '批次',
  ...
  ja: {
    ...
    autoWorkflowDefinition: 'ワークフロー元定義',
    autoBatchInfo: 'バッチ',
  ...
  ko: {
    ...
    autoWorkflowDefinition: '워크플로우 원본 정의',
    autoBatchInfo: '배치',
