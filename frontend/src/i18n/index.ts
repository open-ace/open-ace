...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    autoBranchStrategy: 'Execution Mode',
    autoNewBranch: 'Serial Execution (Recommended)',
    autoWorktree: 'Parallel Execution (Advanced)',
    autoCurrentBranch: 'Same Branch (Serial)',
  ...
  zh: {
    ...
    autoRepoUrl: '仓库',
    autoBranchStrategy: '执行模式',
    autoNewBranch: '串行执行（推荐）',
    autoWorktree: '并行执行（高级）',
    autoCurrentBranch: '同一分支（串行）',
    autoBranchName: '分支名称',
  ...
  ja: {
    ...
    autoRepoUrl: 'リポジトリ',
    autoBranchStrategy: '実行モード',
    autoNewBranch: '直列実行（推奨）',
    autoWorktree: '並列実行（詳細設定）',
    autoCurrentBranch: '同一ブランチ（直列）',
  ...
  ko: {
    ...
    autoRepoUrl: '저장소',
    autoBranchStrategy: '실행 모드',
    autoNewBranch: '순차 실행 (권장)',
    autoWorktree: '병렬 실행 (고급)',
    autoCurrentBranch: '동일 브랜치 (순차)',
