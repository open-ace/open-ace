...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    noMatchingRoleMessages: 'This conversation has no {role} messages',
    expand: 'Expand',
    collapse: 'Collapse',
  ...
  zh: {
    ...
    noMatchingRoleMessages: '该对话中无{role}消息',
    expand: '展开',
    collapse: '收起',
  ...
  ja: {
    ...
    noMatchingRoleMessages: 'この会話には{role}メッセージがありません',
    expand: '展開',
    collapse: '折りたたむ',
  ...
  ko: {
    ...
    noMatchingRoleMessages: '이 대화에 {role} 메시지가 없습니다',
    expand: '펼치기',
    collapse: '접기',
