...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    // Category Management - Issue #2572
    manageCategories: 'Manage Categories',
    createCategory: 'Create Category',
    editCategory: 'Edit Category',
    ...
    categoryNameMaxLength: 'Category name cannot exceed 64 characters',
    matchPatterns: 'Match Patterns',
    patternPlaceholder: 'Enter pattern...',
    patternHint: 'Projects are categorized when path contains these keywords',
    patternNotEmpty: 'Pattern cannot be empty',
    patternMaxLength: 'Pattern cannot exceed 128 characters',
    patternPreview: 'Will match projects containing',
    sortOrder: 'Sort Order',
    sortOrderHint: 'Lower value means higher priority',
    sortOrderRange: 'Sort order must be between 0 and 999',
    ...
    noCategoriesDescription: 'Create categories to organize your projects by matching patterns.',
    manageCategoriesDescription: 'Manage project categories for organizing projects.',
  ...
  zh: {
    ...
    activateCategory: '启用分类',
    categoryName: '分类名称',
    categoryNamePlaceholder: '请输入分类名称',
    categoryNameRequired: '分类名称不能为空',
    categoryNameMaxLength: '分类名称不能超过 64 字符',
    matchPatterns: '匹配规则',
    patternPlaceholder: '请输入匹配关键字...',
    patternHint: '项目路径包含这些关键字时自动归入此分类',
    patternNotEmpty: '匹配规则不能为空字符串',
    patternMaxLength: '单个匹配规则不能超过 128 字符',
    patternPreview: '将匹配路径包含',
    sortOrder: '排序顺序',
    sortOrderHint: '数值越小优先级越高',
    sortOrderRange: '排序值必须在 0-999 之间',
    categoryActive: '启用',
    categoryInactive: '停用',
    deactivateCategoryConfirm: '确定停用分类"{name}"吗？',
    activateCategoryConfirm: '确定启用分类"{name}"吗？',
    deactivate: '停用',
    activate: '启用',
  ...
  ja: {
    ...
    createCategory: 'カテゴリ作成',
    editCategory: 'カテゴリ編集',
    deactivateCategory: 'カテゴリ無効化',
    activateCategory: 'カテゴリ有効化',
    categoryName: 'カテゴリ名',
    categoryNamePlaceholder: 'カテゴリ名を入力',
    categoryNameRequired: 'カテゴリ名は必須です',
    categoryNameMaxLength: 'カテゴリ名は64文字以内で入力してください',
    matchPatterns: 'マッチパターン',
    patternPlaceholder: 'パターンを入力...',
    patternHint: 'プロジェクトパスにこれらのキーワードが含まれると自動的にカテゴリに分類されます',
    patternNotEmpty: 'パターンを空にすることはできません',
    patternMaxLength: 'パターンは128文字以内で入力してください',
    patternPreview: 'マッチするプロジェクト',
    sortOrder: '並び順',
    sortOrderHint: '値が小さいほど優先度が高くなります',
    sortOrderRange: '並び順は0から999の間で入力してください',
    categoryActive: '有効',
    categoryInactive: '無効',
    deactivateCategoryConfirm: 'カテゴリ「{name}」を無効化しますか？',
    activateCategoryConfirm: 'カテゴリ「{name}」を有効化しますか？',
    deactivate: '無効化',
    activate: '有効化',
    categoryCreated: 'カテゴリが作成されました',
    categoryUpdated: 'カテゴリが更新されました',
    categoryDeactivated: 'カテゴリが無効化されました',
    categoryActivated: 'カテゴリが有効化されました',
  ...
  ko: {
    ...
    createCategory: '카테고리 생성',
    editCategory: '카테고리 편집',
    deactivateCategory: '카테고리 비활성화',
    activateCategory: '카테고리 활성화',
    categoryName: '카테고리 이름',
    categoryNamePlaceholder: '카테고리 이름 입력',
    categoryNameRequired: '카테고리 이름은 필수입니다',
    categoryNameMaxLength: '카테고리 이름은 64자 이내로 입력하세요',
    matchPatterns: '매치 패턴',
    patternPlaceholder: '패턴 입력...',
    patternHint: '프로젝트 경로에 이 키워드가 포함되면 자동으로 카테고리에 분류됩니다',
    patternNotEmpty: '패턴은 비워둘 수 없습니다',
    patternMaxLength: '패턴은 128자 이내로 입력하세요',
    patternPreview: '매치될 프로젝트',
    sortOrder: '정렬 순서',
    sortOrderHint: '값이 작을수록 우선순위가 높습니다',
    sortOrderRange: '정렬 순서는 0에서 999 사이여야 합니다',
    categoryActive: '활성',
    categoryInactive: '비활성',
    deactivateCategoryConfirm: '카테고리 "{name}"을 비활성화하시겠습니까?',
    activateCategoryConfirm: '카테고리 "{name}"을 활성화하시겠습니까?',
    deactivate: '비활성화',
    activate: '활성화',
    categoryCreated: '카테고리가 생성되었습니다',
    categoryUpdated: '카테고리가 업데이트되었습니다',
    categoryDeactivated: '카테고리가 비활성화되었습니다',
    categoryActivated: '카테고리가 활성화되었습니다',
    filterByCategory: '카테고리로 필터',
    allCategories: '모든 카테고리',
    noCategories: '카테고리 없음',
    noCategoriesDescription: '매치 패턴으로 프로젝트를 정리하는 카테고리를 생성하세요.',
    manageCategoriesDescription: '프로젝트 정리를 위한 카테고리를 관리합니다.',
    auditAnalysis: '감사 분석',
    ssoSettings: 'SSO 설정',
