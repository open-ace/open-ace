...
export const translations: Record<Language, Translations> = {
  ...
  ja: {
    ...
    noProjectsDescription:
      'プロジェクトはユーザーがワークモードで作成するとここに表示されます。',
    deleteProject: 'プロジェクト削除',
    deleteProjectConfirm: '削除しますか',
    deleteProjectWarning:
      'これは関連データをすべて削除しますが、実際のディレクトリには影響しません。',
    never: 'なし',
    viewDetails: '詳細表示',
    auditAnalysis: '監査分析',
    ssoSettings: 'SSO設定',
    ...
    adminEmail: '管理者メール',
    adminEmailOptional: 'オプション，空の場合自動生成',
    adminUsernameRequired: '管理者ユーザー名は必須',
    adminPasswordRequired: '管理者パスワードは必須',
