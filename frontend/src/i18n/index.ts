...
const translations: Record<Language, Translations> = {
  en: {
    ...
    deletePromptFailed: 'Failed to delete prompt. You can only delete your own prompts.',
    render: 'Render',
  ...
  zh: {
    ...
    deletePromptFailed: '删除提示词失败，您只能删除自己创建的提示词。',
    render: '渲染',
    renderPrompt: '渲染提示词',
    generate: '生成',
  ...
  ja: {
    ...
    deletePromptFailed: 'プロンプトの削除に失敗しました。自分のプロンプトのみ削除できます。',
    render: 'レンダリング',
  ...
  ko: {
    ...
    deletePromptFailed: '프롬프트 삭제에 실패했습니다. 본인이 생성한 프롬프트만 삭제할 수 있습니다.',
    render: '렌더링',
