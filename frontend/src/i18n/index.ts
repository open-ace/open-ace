...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    gatewayEnabledHint:
      'LLM requests will be routed through the LiteLLM gateway. The gateway manages upstream API keys and failover.',
    gatewayEnabledIncomplete: 'Gateway Enabled but Incomplete',
    gatewayEnabledIncompleteHint:
      'Gateway is enabled but configuration is incomplete. Service may return errors.',
    gatewayDisabledConfigured: 'Gateway Disabled',
    gatewayDisabledConfiguredHint:
      'Gateway is configured but not enabled. Click Enable to activate gateway routing.',
    gatewayDisabledIncomplete: 'Gateway Not Configured',
    gatewayDisabledIncompleteHint:
      'Please configure base URL and API key before enabling gateway routing.',
    gatewayEnvOverride: 'Environment Variable Override Active',
    gatewayEnvOverrideHint:
      'Gateway settings are controlled by environment variables. UI controls are disabled.',
    ...
    gatewayVersionConflict:
      'Configuration was modified by another user. Please refresh and try again.',
    gatewayEnableConfirmMessage:
      'Enable gateway routing? All LLM requests will be forwarded through the LiteLLM gateway. Changes will take effect within 10 seconds.',
    gatewayDisableConfirmMessage:
      'Disable gateway routing? Requests will be sent directly to model providers. Changes will take effect within 10 seconds.',
  ...
  zh: {
    ...
    gatewayEnableConfirmMessage:
      '确定启用网关路由？所有 LLM 请求将通过 LiteLLM 网关转发。配置将在 10 秒内生效。',
    gatewayDisableConfirmMessage:
      '确定禁用网关路由？请求将直接发送到模型提供商。配置将在 10 秒内生效。',
