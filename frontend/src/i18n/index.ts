...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    gatewayStatusEnabled: 'Enabled',
    gatewayStatusDisabled: 'Disabled',
    gatewayRoutingToggle: 'Gateway Routing',
    gatewayRoutingToggleDesc: 'Enable or disable gateway routing for LLM requests',
    gatewayEnable: 'Enable',
    gatewayDisable: 'Disable',
    gatewayEnabled: 'Gateway Routing Enabled',
    gatewayEnabledHint: 'LLM requests will be routed through the LiteLLM gateway. The gateway manages upstream API keys and failover.',
    gatewayEnabledIncomplete: 'Gateway Enabled but Incomplete',
    gatewayEnabledIncompleteHint: 'Gateway is enabled but configuration is incomplete. Service may return errors.',
    gatewayDisabledConfigured: 'Gateway Disabled',
    gatewayDisabledConfiguredHint: 'Gateway is configured but not enabled. Click Enable to activate gateway routing.',
    gatewayDisabledIncomplete: 'Gateway Not Configured',
    gatewayDisabledIncompleteHint: 'Please configure base URL and API key before enabling gateway routing.',
    gatewayEnvOverride: 'Environment Variable Override Active',
    gatewayEnvOverrideHint: 'Gateway settings are controlled by environment variables. UI controls are disabled.',
    gatewayEnvConfig: 'Environment Variable Configuration',
    gatewayConfigSource: 'Configuration Source',
    gatewayConfigSourceEnv: 'Environment Variables',
    gatewayConfigSourceDb: 'Database',
    gatewayEnvOverrideWarning: 'Cannot modify gateway settings when environment variables are set',
    gatewayConfigIncompleteWarning: 'Please complete gateway configuration before enabling',
    gatewayVersionConflict: 'Configuration was modified by another user. Please refresh and try again.',
    gatewayEnableConfirmMessage: 'Enable gateway routing? All LLM requests will be forwarded through the LiteLLM gateway. Changes will take effect within 10 seconds.',
    gatewayDisableConfirmMessage: 'Disable gateway routing? Requests will be sent directly to model providers. Changes will take effect within 10 seconds.',
    gatewayBaseUrlRequired: 'Base URL is required',
    gatewayApiKeyHint: 'Leave blank to keep existing key',
    current: 'Current',
    missingFields: 'Missing fields',
    gatewayConfigDeleteConfirm: 'Are you sure you want to delete the gateway configuration?',
    gatewayConfigSaved: 'Gateway Configuration Saved',
    gatewayConfigDeleted: 'Gateway Configuration Deleted',
  ...
  zh: {
    ...
    // Gateway status and controls (Chinese)
    gatewayStatusEnabled: '已启用',
    gatewayStatusDisabled: '已禁用',
    gatewayRoutingToggle: '网关路由',
    gatewayRoutingToggleDesc: '启用或禁用 LLM 请求的网关路由',
    gatewayEnable: '启用',
    gatewayDisable: '禁用',
    gatewayEnabled: '网关路由已启用',
    gatewayEnabledHint: 'LLM 请求将通过 LiteLLM 网关转发，网关管理上游 API 密钥和故障转移。',
    gatewayEnabledIncomplete: '网关已启用但配置不完整',
    gatewayEnabledIncompleteHint: '网关已启用但配置不完整，服务可能返回错误。',
    gatewayDisabledConfigured: '网关未启用',
    gatewayDisabledConfiguredHint: '网关已配置但未启用，点击启用按钮激活网关路由。',
    gatewayDisabledIncomplete: '网关未配置',
    gatewayDisabledIncompleteHint: '请在启用网关路由前配置 Base URL 和 API Key。',
    gatewayEnvOverride: '环境变量覆盖已激活',
    gatewayEnvOverrideHint: '网关设置由环境变量控制，界面控件已禁用。',
    gatewayEnvConfig: '环境变量配置',
    gatewayConfigSource: '配置来源',
    gatewayConfigSourceEnv: '环境变量',
    gatewayConfigSourceDb: '数据库',
    gatewayEnvOverrideWarning: '环境变量已设置，无法通过界面修改网关设置',
    gatewayConfigIncompleteWarning: '请在启用前完成网关配置',
    gatewayVersionConflict: '配置已被其他用户修改，请刷新后重试。',
    gatewayEnableConfirmMessage: '确定启用网关路由？所有 LLM 请求将通过 LiteLLM 网关转发。配置将在 10 秒内生效。',
    gatewayDisableConfirmMessage: '确定禁用网关路由？请求将直接发送到模型提供商。配置将在 10 秒内生效。',
    gatewayBaseUrlRequired: 'Base URL 为必填项',
    gatewayApiKeyHint: '留空则保留现有密钥',
    current: '当前',
    missingFields: '缺失字段',
    gatewayConfigDeleteConfirm: '确定要删除网关配置吗？',
    gatewayConfigSaved: '网关配置已保存',
    gatewayConfigDeleted: '网关配置已删除',
    notVerified: '未验证',
