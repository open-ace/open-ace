...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    noRoleMessages: 'This conversation has no messages of the selected type',
  ...
  ja: {
    ...
    noRoleMessages: 'この会話には選択した種類のメッセージがありません',
  ...
  ko: {
    ...
    noRoleMessages: '이 대화에는 선택한 유형의 메시지가 없습니다',
