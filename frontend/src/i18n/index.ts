...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    noProvidersDescription: 'Register an SSO provider to enable single sign-on for your users. You can quickly register popular providers like Google, Microsoft, or GitHub.',
    ...
    // SSO Enhanced Features
    ssoProviderDetail: 'Provider Details',
    ...
    testConnectionBusy: 'Test connection busy, please try again later',
    exportProviders: 'Export Configuration',
    resetToDefaults: 'Reset to Defaults',
    quickRegister: 'Quick Register',
    step1SelectProvider: 'Step 1: Select Provider',
    step2EnterDomain: 'Step 2: Enter Domain URL',
    step3EnterCredentials: 'Step 3: Enter OAuth Credentials',
    step4ConfirmSubmit: 'Step 4: Confirm and Submit',
    domainUrl: 'Domain URL',
    domainUrlFormatError: 'Invalid Domain URL format',
    useStandardDomainHint: 'Please use Okta/Auth0 standard domain (e.g., https://example.okta.com)',
    updatedConflict: 'Configuration has been modified by others, please refresh and try again',
    providerAutoEnabled: 'Provider has been auto-enabled',
    authorizationUrlNotAccessible: 'Authorization URL not accessible',
    tokenUrlNotAccessible: 'Token URL not accessible',
    connectionTimeout: 'Connection timeout',
    cannotConnectServer: 'Cannot connect to server',
    clientIdInvalid: 'Invalid Client ID format',
    scopeInvalid: 'Invalid Scope configuration',
  ...
  zh: {
    ...
    noProvidersDescription: '注册一个 SSO 提供者以启用单点登录功能。您可以快速注册 Google、Microsoft 或 GitHub 等常用提供者。',
    ...
    confirmClientSecret: '确认客户端密钥',
    confirmClientSecretPlaceholder: '再次输入客户端密钥',
    secretMismatch: '两次输入的密钥不一致',
    urlFormatError: 'URL 必须以 http:// 或 https:// 开头',
    view: '查看',
    test: '测试',
    ...
    // SSO 增强功能
    ssoProviderDetail: 'Provider 详情',
    editProvider: '编辑 Provider',
    enableProvider: '启用 Provider',
    disableProvider: '禁用 Provider',
    testConnectionSuccess: '连接测试成功',
    testConnectionFailed: '连接测试失败',
    testConnectionBusy: '测试连接繁忙，请稍后再试',
    exportProviders: '导出配置',
    resetToDefaults: '恢复默认配置',
    quickRegister: '快速注册',
    step1SelectProvider: '步骤 1: 选择 Provider',
    step2EnterDomain: '步骤 2: 输入 Domain URL',
    step3EnterCredentials: '步骤 3: 输入 OAuth 凭证',
    step4ConfirmSubmit: '步骤 4: 确认并提交',
    domainUrl: 'Domain URL',
    domainUrlFormatError: 'Domain URL 格式不正确',
    useStandardDomainHint: '请使用 Okta/Auth0 标准域名（如 https://example.okta.com）',
    updatedConflict: '配置已被他人修改，请刷新后重新编辑',
    providerAutoEnabled: 'Provider 已自动启用',
    authorizationUrlNotAccessible: '授权端点无法访问',
    tokenUrlNotAccessible: 'Token 端点无法访问',
    connectionTimeout: '连接超时',
    cannotConnectServer: '无法连接到服务器',
    clientIdInvalid: 'Client ID 格式无效',
    scopeInvalid: 'Scope 配置无效',
    testResults: '测试结果',
    passed: '通过',
    changeSecret: '修改密钥',
    urlPreview: 'URL 预览',
  ...
  ja: {
    ...
    noProvidersDescription: 'SSOプロバイダーを登録して、ユーザーのシングルサインオンを有効にします。Google、Microsoft、GitHubなどの一般的なプロバイダーを素早く登録できます。',
    ...
    confirmClientSecret: 'クライアントシークレット確認',
    confirmClientSecretPlaceholder: 'クライアントシークレットを再入力',
    secretMismatch: 'クライアントシークレットが一致しません',
    urlFormatError: 'URLは http:// または https:// で始まる必要があります',
    view: '表示',
    test: 'テスト',
    clickToViewDetails: 'クリックして詳細を表示',
    redirectUri: 'リダイレクト URI',
    enterRedirectUri: 'リダイレクト URI を入力してください',
    scope: 'スコープ',
    customProviderUrls: 'カスタムプロバイダー URL',
    authorizationUrl: '認可 URL',
    tokenUrl: 'Token URL',
    ...
    // SSO Enhanced Features
    ssoProviderDetail: 'Provider 詳細',
    editProvider: 'Provider 編集',
    enableProvider: 'Provider 有効化',
    disableProvider: 'Provider 無効化',
    testConnectionSuccess: '接続テスト成功',
    testConnectionFailed: '接続テスト失敗',
    testConnectionBusy: '接続テストがビジー状態です。後でもう一度お試しください',
    exportProviders: '設定エクスポート',
    resetToDefaults: 'デフォルトにリセット',
    quickRegister: 'クイック登録',
    step1SelectProvider: 'ステップ 1: Provider 選択',
    step2EnterDomain: 'ステップ 2: Domain URL 入力',
    step3EnterCredentials: 'ステップ 3: OAuth 認証情報入力',
    step4ConfirmSubmit: 'ステップ 4: 確認して送信',
    domainUrl: 'Domain URL',
    domainUrlFormatError: 'Domain URL の形式が無効です',
    useStandardDomainHint: 'Okta/Auth0 標準ドメインを使用してください（例: https://example.okta.com）',
    updatedConflict: '設定が他のユーザーによって変更されました。更新して再試行してください',
    providerAutoEnabled: 'Provider が自動的に有効化されました',
    authorizationUrlNotAccessible: '認可 URL にアクセスできません',
    tokenUrlNotAccessible: 'Token URL にアクセスできません',
    connectionTimeout: '接続タイムアウト',
    cannotConnectServer: 'サーバーに接続できません',
    clientIdInvalid: 'Client ID の形式が無効です',
    scopeInvalid: 'Scope の設定が無効です',
    testResults: 'テスト結果',
    passed: '合格',
    changeSecret: 'シークレット変更',
    urlPreview: 'URL プレビュー',
    providerDisabled: 'Provider が無効化されました',
    providerEnabled: 'Provider が有効化されました',
  ...
  ko: {
    ...
    // SSO Provider Settings
    registeredProviders: '등록된 SSO 제공업체',
    noProvidersRegistered: '등록된 SSO 제공업체가 없습니다',
    noProvidersDescription: '사용자의 단일 로그인을 활성화하기 위해 SSO 제공업체를 등록하세요. Google, Microsoft, GitHub과 같은 인기 제공업체를 빠르게 등록할 수 있습니다.',
    availableProviders: '사용 가능한 제공업체',
    addProvider: '제공업체 추가',
    providerName: '제공업체 이름',
    providerType: '제공업체 유형',
    selectProvider: '제공업체 선택',
    customProvider: '사용자 지정 제공업체',
    enterProviderName: '제공업체 이름을 입력하세요',
    clientId: '클라이언트 ID',
    enterClientId: '클라이언트 ID를 입력하세요',
    clientSecret: '클라이언트 비밀키',
    enterClientSecret: '클라이언트 비밀키를 입력하세요',
    confirmClientSecret: '클라이언트 비밀키 확인',
    confirmClientSecretPlaceholder: '클라이언트 비밀키 다시 입력',
    secretMismatch: '클라이언트 비밀키가 일치하지 않습니다',
    urlFormatError: 'URL은 http:// 또는 https://로 시작해야 합니다',
    view: '보기',
    test: '테스트',
    clickToViewDetails: '클릭하여 상세 정보 보기',
    redirectUri: '리디렉션 URI',
    enterRedirectUri: '리디렉션 URI를 입력하세요',
    scope: '범위',
    ...
    clientSecretRequired: '클라이언트 비밀키는 필수입니다',
    providerNameRequired: '제공업체 이름은 필수입니다',
    registerFailed: '제공업체 등록에 실패했습니다',
    providerRegistered: '제공업체가 성공적으로 등록되었습니다',
    confirmDisableProvider: '이 제공업체를 비활성화하시겠습니까?',

    // SSO Enhanced Features
    ssoProviderDetail: 'Provider 상세',
    editProvider: 'Provider 편집',
    enableProvider: 'Provider 활성화',
    disableProvider: 'Provider 비활성화',
    testConnection: '연결 테스트',
    testConnectionSuccess: '연결 테스트 성공',
    testConnectionFailed: '연결 테스트 실패',
    testConnectionBusy: '연결 테스트가 사용 중입니다. 나중에 다시 시도하세요',
    exportProviders: '구성 내보내기',
    resetToDefaults: '기본값으로 재설정',
    quickRegister: '빠른 등록',
    step1SelectProvider: '1단계: Provider 선택',
    step2EnterDomain: '2단계: Domain URL 입력',
    step3EnterCredentials: '3단계: OAuth 자격 증명 입력',
    step4ConfirmSubmit: '4단계: 확인 및 제출',
    domainUrl: 'Domain URL',
    domainUrlFormatError: 'Domain URL 형식이 잘못되었습니다',
    useStandardDomainHint: 'Okta/Auth0 표준 도메인을 사용하세요 (예: https://example.okta.com)',
    updatedConflict: '구성이 다른 사용자에 의해 수정되었습니다. 새로고침 후 다시 시도하세요',
    providerAutoEnabled: 'Provider가 자동으로 활성화되었습니다',
    authorizationUrlNotAccessible: '인증 URL에 액세스할 수 없습니다',
    tokenUrlNotAccessible: 'Token URL에 액세스할 수 없습니다',
    connectionTimeout: '연결 시간 초과',
    cannotConnectServer: '서버에 연결할 수 없습니다',
    clientIdInvalid: 'Client ID 형식이 잘못되었습니다',
    scopeInvalid: 'Scope 구성이 잘못되었습니다',
    testResults: '테스트 결과',
    passed: '통과',
    failed: '실패',
    changeSecret: '비밀 변경',
    ...
    providerEnabled: 'Provider가 활성화되었습니다',
