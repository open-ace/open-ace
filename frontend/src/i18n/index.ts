...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    businessProjectManagement: 'Business Project Management',
    businessProjectsDesc:
      'Manage predefined business projects for workspace categorization and statistics.',
    createBusinessProject: 'Create Business Project',
    editBusinessProject: 'Edit Business Project',
    deleteBusinessProject: 'Delete Business Project',
    projectCode: 'Project Code',
    keyPatterns: 'Key Patterns',
    keyPatternsDesc: 'Patterns used to automatically match workspaces to this business project.',
    patternPlaceholder: 'Enter a pattern (e.g., /project-name/)',
    namePlaceholder: 'Enter project name',
    codePlaceholder: 'Enter unique code (e.g., PROJECT-001)',
    descriptionPlaceholder: 'Enter description',
    totalBusinessProjects: 'Total Business Projects',
    noBusinessProjects: 'No business projects',
    noBusinessProjectsDesc:
      'Create business projects to categorize workspaces and aggregate statistics.',
    businessProjectCreated: 'Business project created successfully',
    businessProjectUpdated: 'Business project updated successfully',
    businessProjectDeleted: 'Business project deleted successfully',
    confirmDeleteBusinessProject: 'Are you sure you want to delete business project',
    deleteBusinessProjectWarning:
      'This will remove the project but workspaces will remain uncategorized.',
    ...
    noMembersDesc: 'Add members to grant them access to this business project.',
  ...
  zh: {
    ...
    businessProjects: '业务项目',
    businessProjectManagement: '业务项目管理',
    businessProjectsDesc: '管理预定义的业务项目，用于工作区分类和统计聚合。',
    createBusinessProject: '创建业务项目',
    editBusinessProject: '编辑业务项目',
    deleteBusinessProject: '删除业务项目',
    projectCode: '项目代码',
    keyPatterns: '匹配模式',
    keyPatternsDesc: '用于自动将工作区匹配到此业务项目的模式字符串。',
    patternPlaceholder: '输入模式（如 /project-name/）',
    namePlaceholder: '输入项目名称',
    codePlaceholder: '输入唯一代码（如 PROJECT-001）',
    descriptionPlaceholder: '输入描述',
    totalBusinessProjects: '总业务项目数',
    noBusinessProjects: '暂无业务项目',
    noBusinessProjectsDesc: '创建业务项目以分类工作区并聚合统计数据。',
    businessProjectCreated: '业务项目创建成功',
    businessProjectUpdated: '业务项目更新成功',
    businessProjectDeleted: '业务项目删除成功',
    confirmDeleteBusinessProject: '确定要删除业务项目',
    deleteBusinessProjectWarning: '此操作将删除项目，但工作区将保持未分类状态。',
    projectMembers: '项目成员',
    statistics: '统计数据',
    ...
    noMembers: '暂无成员',
    noMembersDesc: '添加成员以授予他们对此业务项目的访问权限。',
    userIdPlaceholder: '输入用户ID',
    nameAndCodeRequired: '名称和代码为必填项',
    project: '项目',
    projectDetails: '项目详情',
    projectPath: '项目路径',
    totalProjects: '总项目数',
  ...
  ja: {
    ...
    businessProjects: 'ビジネスプロジェクト',
    businessProjectManagement: 'ビジネスプロジェクト管理',
    businessProjectsDesc:
      'ワークスペースの分類と統計のための事前定義されたビジネスプロジェクトを管理します。',
    createBusinessProject: 'ビジネスプロジェクト作成',
    editBusinessProject: 'ビジネスプロジェクト編集',
    deleteBusinessProject: 'ビジネスプロジェクト削除',
    projectCode: 'プロジェクトコード',
    keyPatterns: 'キーパターン',
    keyPatternsDesc: 'ワークスペースをこのビジネスプロジェクトに自動的にマッチングするパターン。',
    patternPlaceholder: 'パターンを入力（例：/project-name/）',
    namePlaceholder: 'プロジェクト名を入力',
    codePlaceholder: '一意のコードを入力（例：PROJECT-001）',
    descriptionPlaceholder: '説明を入力',
    totalBusinessProjects: '総ビジネスプロジェクト数',
    noBusinessProjects: 'ビジネスプロジェクトなし',
    noBusinessProjectsDesc:
      'ビジネスプロジェクトを作成してワークスペースを分類し、統計を集計します。',
    businessProjectCreated: 'ビジネスプロジェクトが正常に作成されました',
    businessProjectUpdated: 'ビジネスプロジェクトが正常に更新されました',
    businessProjectDeleted: 'ビジネスプロジェクトが正常に削除されました',
    confirmDeleteBusinessProject: 'ビジネスプロジェクトを削除してもよろしいですか',
    deleteBusinessProjectWarning:
      'プロジェクトは削除されますが、ワークスペースは未分類のまま残ります。',
    ...
    noMembers: 'メンバーなし',
    noMembersDesc: 'メンバーを追加してこのビジネスプロジェクトへのアクセスを許可します。',
    userIdPlaceholder: 'ユーザーIDを入力',
    nameAndCodeRequired: '名前とコードは必須です',
    project: 'プロジェクト',
    ...
    businessProjects: 'ビジネスプロジェクト',
    businessProjectManagement: 'ビジネスプロジェクト管理',
    businessProjectsDesc: 'ワークスペースの分類と統計のための事前定義されたビジネスプロジェクトを管理します。',
    createBusinessProject: 'ビジネスプロジェクト作成',
    editBusinessProject: 'ビジネスプロジェクト編集',
    deleteBusinessProject: 'ビジネスプロジェクト削除',
    projectCode: 'プロジェクトコード',
    ...
    totalBusinessProjects: '総ビジネスプロジェクト数',
    noBusinessProjects: 'ビジネスプロジェクトなし',
    noBusinessProjectsDesc: 'ビジネスプロジェクトを作成してワークスペースを分類し、統計を集計します。',
    businessProjectCreated: 'ビジネスプロジェクトが正常に作成されました',
    businessProjectUpdated: 'ビジネスプロジェクトが正常に更新されました',
    businessProjectDeleted: 'ビジネスプロジェクトが正常に削除されました',
    confirmDeleteBusinessProject: 'ビジネスプロジェクトを削除してもよろしいですか',
    deleteBusinessProjectWarning: 'プロジェクトは削除されますが、ワークスペースは未分類のまま残ります。',
    projectMembers: 'プロジェクトメンバー',
    statistics: '統計',
    totalWorkspaces: '総ワークスペース数',
    totalDuration: '総時間',
  ...
  ko: {
    ...
    businessProjects: '비즈니스 프로젝트',
    businessProjectManagement: '비즈니스 프로젝트 관리',
    businessProjectsDesc:
      '워크스페이스 분류 및 통계를 위해 미리 정의된 비즈니스 프로젝트를 관리합니다.',
    createBusinessProject: '비즈니스 프로젝트 생성',
    editBusinessProject: '비즈니스 프로젝트 편집',
    deleteBusinessProject: '비즈니스 프로젝트 삭제',
    projectCode: '프로젝트 코드',
    keyPatterns: '키 패턴',
    keyPatternsDesc: '워크스페이스를 이 비즈니스 프로젝트에 자동으로 매칭하는 패턴입니다.',
    patternPlaceholder: '패턴 입력 (예: /project-name/)',
    namePlaceholder: '프로젝트 이름 입력',
    codePlaceholder: '고유 코드 입력 (예: PROJECT-001)',
    ...
    members: '멤버',
    addMember: '멤버 추가',
    memberAdded: '멤버가 성공적으로 추가되었습니다',
    memberRemoved: '멤버가 성공적으로 삭제되었습니다',
    failedToAddMember: '멤버 추가 실패',
    failedToRemoveMember: '멤버 삭제 실패',
    noMembers: '멤버 없음',
    noMembersDesc: '멤버를 추가하여 이 비즈니스 프로젝트에 대한 접근 권한을 부여합니다.',
    userIdPlaceholder: '사용자 ID 입력',
    nameAndCodeRequired: '이름과 코드는 필수입니다',
    project: '프로젝트',
    projectDetails: '프로젝트 상세',
    projectPath: '프로젝트 경로',
    totalProjects: '전체 프로젝트',
    totalUsers: '전체 사용자',
    totalWorkTime: '전체 작업 시간',
    workTime: '작업 시간',
    lastActive: '마지막 활동',
    firstAccess: '첫 접근',
    projectManagement: '프로젝트 관리',
    businessProjects: '비즈니스 프로젝트',
    businessProjectManagement: '비즈니스 프로젝트 관리',
    businessProjectsDesc: '워크스페이스 분류 및 통계를 위한 미리 정의된 비즈니스 프로젝트를 관리합니다.',
    createBusinessProject: '비즈니스 프로젝트 생성',
    editBusinessProject: '비즈니스 프로젝트 편집',
    deleteBusinessProject: '비즈니스 프로젝트 삭제',
    projectCode: '프로젝트 코드',
    ...
    failedToRemoveMember: '멤버 삭제 실패',
    noMembers: '멤버 없음',
    noMembersDesc: '이 비즈니스 프로젝트에 대한 액세스를 허용하려면 멤버를 추가하세요.',
    userIdPlaceholder: '사용자 ID 입력',
    nameAndCodeRequired: '이름과 코드는 필수입니다',
    project: '프로젝트',
    projectDetails: '프로젝트 상세',
