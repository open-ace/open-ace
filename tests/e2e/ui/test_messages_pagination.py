                ...
                if next_count > 0:
                    ...
                    if next_button_class and "disabled" not in next_button_class:
                        ...
                        if current_count > 0 and total_count > 0:
                            ...
                            if new_current_page != current_page_text:
                                ...
                                if prev_count > 0:
                                    ...
                                    if prev_button_class and "disabled" not in prev_button_class:
                                        ...
                                        assert final_page == current_page_text, (
                                            f"Previous button did not return to page "
                                            f"{current_page_text}: {final_page}"
                                        )
                                    else:
                            ...
                            assert (
                                new_current_page != current_page_text
                            ), "Page number did not update after clicking Next (issue #55)"
                        else:
