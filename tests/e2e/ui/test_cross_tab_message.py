        ...
        try:
            ...
            if tab1_frame:
                ...
                try:
                    ...
                    assert not found_cross_content, (
                        "Tab 1 leaked Tab 2 task content (cross-tab isolation broken): "
                        f"{found_cross_content}"
                    )
            ...
            if tab2_frame:
                ...
                try:
                    ...
                    assert (
                        not found_tab1_content
                    ), f"Tab 2 leaked Tab 1 message content: {found_tab1_content}"
