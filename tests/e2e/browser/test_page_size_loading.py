...
Usage:
    python3 tests/e2e/browser/test_page_size_loading.py
"""
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            if await page_size_select.count() > 0:
                ...
                assert not result[
                    "noSessionsFound"
                ], "'No sessions found' was shown during Page Size change"
            ...
            assert test_passed, f"page-size loading check(s) failed: {error_messages}"
