...
Run:
  HEADLESS=true  python tests/e2e/manage/e2e_api_key_toggle.py   # Test
  HEADLESS=false python tests/e2e/manage/e2e_api_key_toggle.py   # Demo
"""
...
pytestmark = [pytest.mark.regression, pytest.mark.issue(435)]
