...
Run:
  HEADLESS=true  python tests/e2e/manage/e2e_project_stats_accuracy.py
  HEADLESS=false python tests/e2e/manage/e2e_project_stats_accuracy.py
"""
...
pytestmark = [pytest.mark.regression, pytest.mark.issue(210)]
