...
Run:
  HEADLESS=true  python tests/e2e/manage/e2e_audit_analysis_playwright.py   # 自动测试
...
pytestmark = [pytest.mark.regression, pytest.mark.issue(198)]
...
def test_i18n_translations():
    ...
    assert r.status_code == 200, f"frontend index page returned {r.status_code}"
