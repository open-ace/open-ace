...
class TestAggregateDailyStats:
    ...
    def test_aggregate_multiple_entries(self):
        ...
        entries = [
            {'tokens_used': 100, 'input_tokens': 80, 'output_tokens': 20, 'cache_tokens': 10, 'models_used': ['gpt-4']},
            {'tokens_used': 200, 'input_tokens': 150, 'output_tokens': 50, 'cache_tokens': 20, 'models_used': ['claude-3']},
            {'tokens_used': 50, 'input_tokens': 40, 'output_tokens': 10, 'cache_tokens': 5, 'models_used': ['gpt-4', 'gpt-3.5']}
        ]
        result = aggregate_daily_stats(entries)
