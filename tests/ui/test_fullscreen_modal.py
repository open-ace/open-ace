    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            if await fullscreen_btn.count() > 0:
                ...
                fullscreen_div = page.locator('.conversation-history-fullscreen, [class*="fullscreen"]')
                ...
                if close_count > 0:
                    ...
                    try:
                        ...
                        if not modal_still_visible:
                            print("   ✓ Modal closed successfully - Modal is clickable in fullscreen!")
                            test_results.append(("Modal Clickable in Fullscreen", "PASS", "Close button worked"))
                        else:
                            ...
                            if not is_visible:
                                ...
                                test_results.append(("Modal Clickable in Fullscreen", "FAIL", "Modal did not close"))
                    ...
                    test_results.append(("Modal Clickable in Fullscreen", "WARN", "No close button"))
            else:
