...
async def test_create_button_full():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            print(f"⚠️ 点击失败: {e}")
            await page.screenshot(path=os.path.join(SCREENSHOT_DIR, "full_test_09_click_failed.png"))
            await browser.close()
            return False
        ...
        print("\n=== 步骤 7: 检查结果 ===")
        project_api_calls = [c for c in api_calls if 'projects' in c['url'] and c['method'] == 'POST']
