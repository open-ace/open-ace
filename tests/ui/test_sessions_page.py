...
def test_sessions_page():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            sessions_btn = page.locator('.sidebar button:has-text("Sessions"), .sidebar button:has-text("会话")')
            sessions_btn.click()
            ...
            # 8. 测试刷新按钮
            print("\n步骤 8: 测试刷新按钮")
            refresh_btn = page.locator('.sessions-header button:has-text("Refresh"), .sessions-header button:has(.bi-arrow-clockwise)')
