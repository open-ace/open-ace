    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            if request_spans.count() > 0:
                ...
                has_raw_req = "req" in first_request_text and "request" not in first_request_text.lower()
            ...
            if session_count > 0:
                ...
                has_updated_time = "Last Active" in meta_text or "最后活跃" in meta_text or "updated" in meta_text.lower()
