...
def test_analysis_charts():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            heatmap_heading = page.locator('h5:has-text("Usage Heatmap"), .card-title:has-text("Usage Heatmap"), h5:has-text("使用热力图")')
            ...
            top_tools_heading = page.locator('h5:has-text("Top Tools"), .card-title:has-text("Top Tools"), h5:has-text("热门工具")')
            ...
            peak_heading = page.locator('h5:has-text("Peak Usage"), .card-title:has-text("Peak Usage"), h5:has-text("峰值")')
            if peak_heading.count() > 0:
                print("  ✓ Peak Usage Periods heading found")
                # Check for table rows - use ancestor to get the card
                peak_card = peak_heading.first.locator('xpath=ancestor::div[contains(@class, "card")]')
            ...
            users_heading = page.locator('h5:has-text("Active Users"), .card-title:has-text("Active Users"), h5:has-text("活跃用户")')
            if users_heading.count() > 0:
                print("  ✓ Active Users heading found")
                # Check for table rows - use ancestor to get the card
                users_card = users_heading.first.locator('xpath=ancestor::div[contains(@class, "card")]')
            ...
            tool_comp_heading = page.locator('h5:has-text("Tool Comparison"), .card-title:has-text("Tool Comparison"), h5:has-text("工具对比")')
            ...
            token_dist_heading = page.locator('h5:has-text("Token Distribution"), .card-title:has-text("Token Distribution"), h5:has-text("Token 分布")')
