...
async def test_interactive():
    ...
    with open(LOG_FILE, "w") as f:
        f.write(f"=== Create Button Interactive Test Log ===\n")
    ...
    async with async_playwright() as p:
        ...
        select_btn = iframe.locator('button:has-text("Select This Folder"), button:has-text("选择此文件夹")')
        try:
        ...
        try:
            ...
            await page.screenshot(path=os.path.join(SCREENSHOT_DIR, "interactive_07_no_details.png"))
            input("按 Enter 关闭浏览器...")
            await browser.close()
            return
        ...
        # 保存截图让用户看到当前状态
        await page.screenshot(path=os.path.join(SCREENSHOT_DIR, "interactive_09_ready_for_click.png"))
        ...
        for i in range(60):
            ...
            if i % 10 == 0:
                ...
                await page.screenshot(path=os.path.join(SCREENSHOT_DIR, f"interactive_10_waiting_{i}s.png"))
