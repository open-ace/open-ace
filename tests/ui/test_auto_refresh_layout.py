            ...
            if auto_refresh_switch.count() > 0:
                ...
                if label.count() > 0:
                    ...
                    if switch_box and label_box:
                        ...
                        results.append(('Dashboard Auto Refresh', 'PASS' if same_line else 'FAIL', 
                                       f'Y-diff: {y_diff:.1f}px, Same line: {same_line}'))
                        print(f"  Switch Y: {switch_box['y']:.1f}, Label Y: {label_box['y']:.1f}, Diff: {y_diff:.1f}px")
                    else:
                        results.append(('Dashboard Auto Refresh', 'FAIL', 'Could not get bounding boxes'))
                else:
            ...
            if auto_refresh_switch.count() > 0:
                ...
                if label.count() > 0:
                    ...
                    if switch_box and label_box:
                        ...
                        results.append(('Analysis Auto Refresh', 'PASS' if same_line else 'FAIL', 
                                       f'Y-diff: {y_diff:.1f}px, Same line: {same_line}'))
                        print(f"  Switch Y: {switch_box['y']:.1f}, Label Y: {label_box['y']:.1f}, Diff: {y_diff:.1f}px")
                else:
            ...
            if auto_refresh_switch.count() > 0:
                ...
                if label.count() > 0:
                    ...
                    if switch_box and label_box:
                        ...
                        results.append(('Messages Auto Refresh', 'PASS' if same_line else 'FAIL', 
                                       f'Y-diff: {y_diff:.1f}px, Same line: {same_line}'))
                        print(f"  Switch Y: {switch_box['y']:.1f}, Label Y: {label_box['y']:.1f}, Diff: {y_diff:.1f}px")
                else:
