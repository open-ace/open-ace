...
async def test_new_folder_create():
    async with async_playwright() as p:
        ...
        # 找到 New Folder 按钮
        new_folder_btn = iframe.locator('button:has-text("New Folder"), button:has-text("新建文件夹")')
        ...
        print("\n=== 步骤 4: 填写新文件夹名称 ===")
        # 找到新文件夹输入框
        new_dir_input = iframe.locator('input[placeholder*="name"], input[placeholder*="名称"]').first
