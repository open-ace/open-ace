...
def test_dashboard_charts():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            dashboard_nav = page.locator('a:has-text("Dashboard"), #nav-dashboard, [href="#/dashboard"]')
            ...
            trend_chart_heading = page.locator('h5:has-text("Trend Chart"), .card-title:has-text("Trend Chart")')
            ...
            token_dist_heading = page.locator('h5:has-text("Token Distribution"), .card-title:has-text("Token Distribution")')
