...
async def test_click_debug():
    ...
    async with async_playwright() as p:
        ...
        select_folder_btn = page.locator('button:has-text("Select This Folder"), button:has-text("选择此文件夹")')
        try:
            ...
            try:
                if await up_btn.is_visible(timeout=2000):
                    ...
                    if dir_buttons:
                        ...
                        # 点击 Select 按钮
                        select_btn = page.locator('button:has-text("select"), button:has-text("选择")').first
        ...
        create_button = page.locator('[role="dialog"] button:has-text("Add Project"), .bg-white button:has-text("Add Project"), .dark:bg-slate-800 button:has-text("Add Project")').first
        try:
