#!/usr/bin/env python3
"""
MANUAL DIAGNOSTIC SCRIPT — NOT COLLECTED BY PYTEST.
Run directly: python tests/issues/166/manual_stream_json_mode.py
"""
...
def run_stream_json_diagnostic(env_name: str, env_mods: dict) -> dict:
...
def main():
    ...
    for config in TEST_ENVIRONMENTS:
        result = run_stream_json_diagnostic(config["name"], config["env_mods"])
