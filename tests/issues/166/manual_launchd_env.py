...
Run directly: python tests/issues/166/manual_launchd_env.py
"""
...
def run_qwen_cli_diagnostic(env_name: str, env_mods: dict) -> dict:
...
def main():
    ...
    for config in TEST_ENVIRONMENTS:
        result = run_qwen_cli_diagnostic(config["name"], config["env_mods"])
