    ...
    try:
        ...
        if page_size_select.count() > 0:
            ...
            if new_page_size == 50:
                ...
                test_passed = False
                error_messages.append(f"Page Size not changed correctly. Expected: 50, Got: {new_page_size}")
            ...
            if result['noSessionsFound']:
                test_passed = False
                error_messages.append("'No sessions found' was shown during second Page Size change")
