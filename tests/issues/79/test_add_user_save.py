...
async def test_add_user_save():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # 填写用户名
            username_input = page.locator('input[name="username"], input[placeholder*="username"], input[placeholder*="用户名"]').first
            ...
            # 检查页面上的错误信息
            error_elements = page.locator('.alert-danger, .error, [class*="error"], [class*="alert"]')
