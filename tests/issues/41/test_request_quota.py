        ...
        try:
            ...
            try:
                ...
                if e.code == 401 and "quota" in endpoint:
                    ...
                    results.append(
                        {"endpoint": endpoint, "name": name, "status": "FAIL", "error": str(e)}
                    )
...
def take_screenshots():
    ...
    with sync_playwright() as p:
        ...
        try:
            page.goto(
                f"{BASE_URL}/manage/analysis/request-dashboard",
        ...
        try:
            ...
            page.screenshot(path=str(filepath), full_page=True)
            screenshots.append(
                {"filename": filename, "description": "Usage Overview (Work)", "url": "/work/usage"}
            )
            print(f"✓ Saved: {filename}")
        except Exception as e:
