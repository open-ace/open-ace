...
SCREENSHOT_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))), "screenshots", "issues", "48")
...
def test_status_bar_improvements():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            assert "bi-bar-chart" in icon_class, f"Token icon should be bi-bar-chart, got {icon_class}"
            ...
            assert "Token" in label_text or "トークン" in label_text or "토큰" in label_text, f"Token label should be localized, got {label_text}"
            ...
            assert "bi-arrow-up-circle" in icon_class, f"Request icon should be bi-arrow-up-circle, got {icon_class}"
            ...
            assert "Request" in label_text or "请求" in label_text or "リクエスト" in label_text or "요청" in label_text, f"Request label should be localized, got {label_text}"
