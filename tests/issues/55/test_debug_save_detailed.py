    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            for i in range(inputs.count()):
                ...
                label = input_el.evaluate('el => el.closest(".col-md-6")?.querySelector("label")?.textContent || "No label"')
            ...
            for i in range(15):
                ...
                print(f"  [{i+1}s] Modal: {'visible' if modal_visible else 'closed'}, Spinner: {has_spinner}")
