...
async def test_issue30_v3():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # 3. 截图
            await page.screenshot(path=f"{SCREENSHOT_DIR}/issue30_v3_messages.png", full_page=True)
            print("   ✓ 截图保存: issue30_v3_messages.png")
            ...
            import traceback
            traceback.print_exc()
            await page.screenshot(path=f"{SCREENSHOT_DIR}/issue30_v3_error.png")
