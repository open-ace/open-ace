...
async def main():
    async with async_playwright() as p:
        ...
        await page.screenshot(path='screenshots/issue15_test_02_conversation_history.png', full_page=True)
        ...
        if first_row:
            ...
            await page.screenshot(path='screenshots/issue15_test_03_modal_opened.png', full_page=True)
            ...
            if modal:
                ...
                if modal_content:
                    await modal_content.screenshot(path='screenshots/issue15_test_04_modal_content.png')
