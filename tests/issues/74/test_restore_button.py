...
async def test_restore_button():
    ...
    async with async_playwright() as p:
        ...
        # Take screenshot
        await page.screenshot(path="/Users/rhuang/workspace/open-ace/screenshots/issues/74/sessions_page.png", full_page=True)
        ...
        action_area = await first_card.locator(".d-flex.flex-column.gap-2").evaluate("el => el.outerHTML")
        print(f"\n6. Action area HTML:\n{action_area}")
