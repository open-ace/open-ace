...
def test_add_prompt():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            name_input = modal.locator('.form-group:has(label:has-text("Name")) input, input.form-control').first
            ...
            # Take screenshot
            screenshot_path = "/Users/rhuang/workspace/open-ace/screenshots/issues/99/after_create_click.png"
