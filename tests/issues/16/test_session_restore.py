...
def test_session_restore():
    ...
    with sync_playwright() as p:
        ...
        restore_button = page.locator(".session-item .btn-outline-primary .bi-box-arrow-in-right").first
        ...
        if restore_button.count() > 0:
            ...
            try:
                ...
                if "sessionId=" in current_url:
                    ...
                    print(f"  ✓ URL contains sessionId")
                else:
                ...
                debug_screenshot = os.path.join(SCREENSHOT_DIR, "issues", "16", "debug_workspace.png")
