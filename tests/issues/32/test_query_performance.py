...
def main():
    ...
    t, _ = measure_query(
        ...
        message_repo.get_user_token_totals,
        start_date, end_date
    )
    total_time += t
    ...
    t, _ = measure_query(
        "get_tool_token_totals",
        message_repo.get_tool_token_totals,
        start_date, end_date
    )
    total_time += t
    ...
    t, _ = measure_query(
        "get_daily_token_totals",
        message_repo.get_daily_token_totals,
        start_date, end_date
    )
    total_time += t
    ...
    t, _ = measure_query(
        "get_conversation_stats_summary",
        message_repo.get_conversation_stats_summary
    )
    total_time += t

    # Query 7: get_request_count_total
    t, _ = measure_query(
        "get_request_count_total",
        usage_repo.get_request_count_total,
        start_date, end_date
    )
    total_time += t
