...
pytestmark = [pytest.mark.regression, pytest.mark.issue(1807)]
...
class TestWebhookFailurePrefsUnbound:
    def test_prefs_unbound_does_not_mask_real_exception(self):
        ...
        # db_path is never opened on this path: the prefs getter is patched
        # to raise before any DB touch. Explicit to avoid ambient-DB coupling.
        notifier = AlertNotifier(db_path="round2-unused.db")
