...
def test_insert_params_pass_bool_for_boolean_columns():
    params = CommandExecutionEvidenceRepository._insert_params(_evidence(), None, datetime.now(UTC))
...
def test_update_params_pass_bool_for_boolean_columns():
    params = CommandExecutionEvidenceRepository._update_params(_evidence(), None, datetime.now(UTC))
