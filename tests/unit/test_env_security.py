...
Migrated from tests/issues/2019/test_env_security.py (sys.path bootstrap
re-scoped for the tests/unit depth).
"""
...
_REMOTE_AGENT = Path(__file__).resolve().parents[2] / "remote-agent"
...
pytestmark = [pytest.mark.regression, pytest.mark.issue(2019), pytest.mark.security]
