...
from app.modules.workspace.session_manager import SessionManager, AgentSession, SessionType, SessionStatus
...
from app.modules.workspace.collaboration import CollaborationManager, Team, SharedSession, SharePermission
