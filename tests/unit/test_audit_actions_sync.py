...
class TestAuditActionsSynchronization:
    ...
    def test_audit_action_enum_complete(self):
        ...
        expected_categories = {
            ...
            "Permission": 7,  # PERMISSION_GRANT, REVOKE, SHARED_PROJECT_PERMISSION_SETUP_START, SHARED_PROJECT_PERMISSION_SETUP_COMPLETE (Issue #2745), PROJECT_USER_ADD, PROJECT_USER_REMOVE, PROJECT_USER_BATCH_UPDATE (Issue #3275)
            ...
            "External Identity": 1,  # EXTERNAL_TOKEN_ISSUED
            "SSRF Protection": 5,  # LLM_PROXY_URL_BLOCKED, ALLOWLIST_ENTRY_INVALID, IP_RESOLVED_MISMATCH, SSRF_CONFIG_RESET (Issue #3328), PROXY_KEY_ECHO_BLOCKED
