...
Migrated from tests/issues/1746/test_ws_frame_cors_guards.py (the redundant
project-root sys.path bootstrap was dropped — tests/unit runs from the repo
root; the inner #1859 docstring/class context is kept as-is).
"""
...
pytestmark = [pytest.mark.regression, pytest.mark.issue(1746)]
