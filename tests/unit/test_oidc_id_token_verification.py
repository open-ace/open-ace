...
Migrated from tests/issues/22/test_issue22.py (renamed from the opaque
test_issue22.py; the redundant project-root sys.path bootstrap, the
``pytest.main`` footer, and the executable bit were dropped).
"""
...
pytestmark = [pytest.mark.regression, pytest.mark.issue(22)]
