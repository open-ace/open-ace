...
class ReportGenerator:
    ...
    def generate_report(
        ...
        if report_type == ReportType.USAGE_SUMMARY.value:
            ...
            summary, details = self._generate_comprehensive_report(period_start, period_end, tenant_id)
        else:
            summary, details = {}, []
    ...
    def _generate_security_report(
        ...
        security_actions = [
            ...
            'user_password_change', 'user_role_change', 'permission_grant',
            'permission_revoke', 'content_blocked', 'content_flagged',
        ]
    ...
    def _generate_comprehensive_report(
        ...
        audit_summary, audit_details = self._generate_audit_trail(period_start, period_end, tenant_id)
    ...
    def get_saved_report(self, report_id: str) -> Optional[ComplianceReport]:
        ...
        row = self.db.fetch_one(
            'SELECT report_data FROM compliance_reports WHERE report_id = ?',
            (report_id,)
        )
