            ...
            if std_tokens > 0:
                ...
                if z_score > self.SPIKE_THRESHOLD:
                    anomalies.append(Anomaly(
                        ...
                        actual_value=value,
                        deviation_percentage=((value - mean_tokens) / mean_tokens) * 100 if mean_tokens > 0 else 0,
                ...
                # Drop detection
                    ...
                    anomalies.append(Anomaly(
                        ...
                        expected_value=mean_tokens,
                        actual_value=value,
                        deviation_percentage=((mean_tokens - value) / mean_tokens) * 100 if mean_tokens > 0 else 0,
                        severity='low',
