...
- 在自己的网络里部署，保留企业数据边界，并接入 OIDC/OAuth2/SAML SSO、飞书组织架构导入 + 钉钉组织同步和 Kubernetes
...
| 🔌 **企业集成** | 支持 OIDC/OAuth2/SAML 2.0 SSO、飞书组织架构导入 + 钉钉组织同步、钉钉/飞书告警机器人、Kubernetes、反向代理和多租户权限模型 |
