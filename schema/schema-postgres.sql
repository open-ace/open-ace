...
ALTER TABLE ONLY backfill_logs ALTER COLUMN id SET DEFAULT nextval('backfill_logs_id_seq'::regclass);
...
ALTER TABLE ONLY mapping_migration_status ALTER COLUMN id SET DEFAULT nextval('mapping_migration_status_id_seq'::regclass);
...
ALTER TABLE ONLY tool_account_conflicts ALTER COLUMN id SET DEFAULT nextval('tool_account_conflicts_id_seq'::regclass);
...
ALTER TABLE ONLY backfill_logs
    ADD CONSTRAINT backfill_logs_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY mapping_migration_status
    ADD CONSTRAINT mapping_migration_status_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY tool_account_conflicts
    ADD CONSTRAINT tool_account_conflicts_pkey PRIMARY KEY (id);
