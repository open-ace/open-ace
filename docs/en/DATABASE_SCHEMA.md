...
Open ACE supports both SQLite (single-machine) and PostgreSQL (production). The schema contains 103 tables + 1 materialized view (full list in schema-postgres.sql; docs below cover the most commonly referenced tables).
