...
#### 安全与合规
- SSO 集成（OIDC/OAuth2；SAML 2.0 计划见 [#1784](https://github.com/open-ace/open-ace/issues/1784)）
- 全面的审计日志
- 内容过滤
- 数据保留策略
- 符合 GDPR 的数据导出
...
| **治理** | 审计日志、安全、合规、保留 |
| **协作** | 会话共享、提示库、团队工作空间 |
| **集成** | OIDC/OAuth2 SSO、工具连接器、状态同步；SAML 2.0 计划见 [#1784](https://github.com/open-ace/open-ace/issues/1784) |
